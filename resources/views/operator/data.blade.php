                            ...
                            <div class="container mt-3">
                                <div class="d-flex justify-content-between align-items-center flex-wrap">
                                    <form action="{{ url()->current() }}" method="GET"
                                        class="form-inline mb-2 d-flex flex-wrap align-items-center">
                                    ...
                                    <div class="button d-flex flex-wrap align-items-center" style="gap: 10px;">
                                        <a href="/operator/analisakimia" class="btn btn-success mb-2">
                                            <i class="fa fa-plus"></i> Tambah Data
                                        </a>

                                        <a href="/operator/analisakimia/history" class="btn btn-danger mb-2">
                                    ...
                                    <table class="table table-bordered table-md">
                                        ...
                                        @forelse ($futamis as $futami)
                                            <tr>
                                                ...
                                                <td>{{ Carbon\Carbon::parse($futami->tanggal_terima)->translatedFormat('d F Y') }}
                                                </td>
                                                <td>{{ Carbon\Carbon::parse($futami->tanggal_uji)->translatedFormat('d F Y') }}
                                                </td>
                                                <td>{{ Carbon\Carbon::parse($futami->tanggal_selesai)->translatedFormat('d F Y') }}
                                                </td>
                                                {{-- <td>{{$futami->sampel}}</td>
                                                        ...
                                                        <form action="/operatorttd/{{ $futami['id'] }}" method="POST"
                                                            ...
                                                            <div class="form-group col-md-1">
                                                                <input type="date" name="ttd_operator"
                                                                    class="form-control" placeholder="TTD Operator"
                                                                    style="width:120px;">
                                                            </div>
                                                ...
                                                <td align="center">
                                                    <form action="{{ route('delete', $futami['id']) }}" method="POST">
                                                        ...
                                                        <a class="fa-solid fa-pen-to-square text-success btn"
                                                            href="{{ route('edit_data_analisa_kimia', $futami->id) }}"></a>

                                                        <br>
                                                        <a class="fa-solid fa-file-pdf ml-1 btn" target="_blank"
                                                            href="{{ route('operator_analisakimiapdf', $futami->id) }}"></a>

                                                        <a target="_blank"
                                                            href="{{ route('operator_analisakimia_excel_show', $futami->id) }}">
