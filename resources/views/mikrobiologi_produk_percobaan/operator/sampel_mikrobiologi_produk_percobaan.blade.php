    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Tambah Data Sampel Mikrobiologi Produk Percobaan</h1>
            </div>
            ...
            <div class="section-body">
                <h2 class="section-title">Tambah Data Sampel Mikrobiologi Produk Percobaan</h2>
                <div class="row shadow">
                    <div class="col-12">
                        <div class="card">
                            <div class="card">
                                <form action="{{route('sampel_mikrobiologi_produk_percobaan.post', $id)}}" method="POST">
                                  @csrf
                                    ...
                                    <div class="form-row" style="margin-top:1%;">
                                        ...
                                        <div class="form-group col-md-1" align="center">
                                            <label for="tpc">TPC ({{ $mikrobiologiProdukPercobaan->satuan_tpc }})</label>
                                        </div>
                                        <div class="form-group col-md-2" align="center">
                                            <label for="yeast_mold">Yeast & Mold ({{ $mikrobiologiProdukPercobaan->satuan_yeast_mold }})</label>
                                        </div>
                                        <div class="form-group col-md-2" align="center">
                                            <label for="coliform">Coliform ({{ $mikrobiologiProdukPercobaan->satuan_coliform }})</label>
                                        </div>
                                        <div class="form-group col-md-2" align="center">
