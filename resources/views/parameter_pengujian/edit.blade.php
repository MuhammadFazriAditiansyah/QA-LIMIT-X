                                ...
                                <div class="card">
                                    <div class="card">
                                        <form action="{{ route('updateParameter', $parameter->id)}}" method="POST">
                                            ...
                                            <div class="card-body">
                                                <h6 for="parameter" style="text-align:center;">Parameter</h6>
                                                <div class="form-row d-flex justify-content-center align-items-center">
                                                    <div class="form-group col-md-12" align="center">
                                                        <input type="text" name="parameter" value="{{ $parameter->parameter }}" class="form-control" id="parameter" placeholder="Parameter">
                                                    </div>
                                                </div>
                                            </div>
