            ...
            <div class="main-content">
                <section class="section">
                    <div class="section-header">
                        <h1>Edit Data Satuan Parameter Pengujian</h1>
                    </div>
                    ...
                    <div class="section-body">
                        <h2 class="section-title">Edit Data Satuan Parameter Pengujian</h2>

                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card">
                                        <form action="{{ route('updateSatuan', $satuan->id)}}" method="POST">

                                            @csrf
                                            @method('PATCH')

                                            <div class="card-body">
                                                <h6 for="parameter" style="text-align:center;">Satuan</h6>
                                                <div class="form-row d-flex justify-content-center align-items-center">
                                                    <div class="form-group col-md-12" align="center">
                                                        <input type="text" name="satuan" value="{{ $satuan->satuan }}" class="form-control" id="satuan" placeholder="Satuan">
                                                    </div>
                                                </div>
                                            </div>
