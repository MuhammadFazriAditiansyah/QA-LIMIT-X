                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-md">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$mikrobiologi_air->nama_produk}}</td>
                                        ...
                                        <td align="center">
                                            @if($mikrobiologi_air['statusOP'] == 0)
                                                ...
                                                {{-- {!! QrCode::size(80)->generate($mikrobiologi_air->user_id_OP ."_". $mikrobiologi_air->name_id_OP) !!} --}}
                                            @endif
                                        </td>
                                        <td align="center">
                                        ...
                                        <td>
                                            @if($mikrobiologi_air['statusSP'] == 0)
                                                {{-- <form action="/supervisor/mikrobiologi_air/ttd/{{$mikrobiologi_air['id']}}" method="POST" class="text-center">
                                                    @csrf
                                                    @method('PATCH')
                                                    <button type="submit" class="btn btn-success btn">TTD</button>
                                                </form> --}}
                                        ...
                                        <td>
                                            <form action="{{route('delete', $mikrobiologi_air['id'])}}" method="POST" style="text-center">
                                                ...
                                                <a target="_blank" href="{{route('mikrobiologi_air_excel_show', $mikrobiologi_air->id)}}">
