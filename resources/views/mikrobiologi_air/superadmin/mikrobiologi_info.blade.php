                                    ...
                                    <tbody>
                                        @forelse ($mikrobiologi_airs as $mikrobiologi_air)
                                            <tr>
                                                ...
                                                {{-- <td>{{Carbon\Carbon::parse($mikrobiologi_air->tanggal_uji)->translatedFormat('d F Y')}}</td> --}}
                                                <td align="center">
                                                    ...
                                                    @elseif($mikrobiologi_air['statusOP'] == 1)
                                                        <img src="data:image/png;base64, {!! base64_encode( QrCode::format('png')->size(70)->generate($mikrobiologi_air->user_id_OP . '_' . $mikrobiologi_air->name_id_OP), ) !!}" alt="">
                                                    @endif
                                                </td>
                                                <td align="center">
                                                    ...
                                                    @elseif($mikrobiologi_air['statusST'] == 1)
                                                        {{-- {!! QrCode::size(70)->generate($mikrobiologi_air->nodokumen) !!} --}}
                                                        <img src="data:image/png;base64, {!! base64_encode( QrCode::format('png')->size(70)->generate($mikrobiologi_air->user_id_ST . '_' . $mikrobiologi_air->name_id_ST), ) !!}" alt="">
                                                ...
                                                <td align="center">
                                                    ...
                                                    @elseif($mikrobiologi_air['statusSP'] == 1)
                                                        {{-- {!! QrCode::size(70)->generate($mikrobiologi_air->nodokumen) !!} --}}
                                                        <img src="data:image/png;base64, {!! base64_encode( QrCode::format('png')->size(70)->generate($mikrobiologi_air->user_id_SP . '_' . $mikrobiologi_air->name_id_SP), ) !!}" alt="">
                                                    @endif
                                                </td>
                                                <td style="text-align: center;">
                                                    <a class="fa-solid fa-file-pdf ml-1 btn" target="_blank" href="{{ route('superadmin_mikrobiologi_pdf', $mikrobiologi_air->id) }}"></a>
                                                    <a class="fa-solid fa-file-excel ml-1 btn" target="_blank" href="{{ route('mikrobiologi_air_excel_show', $mikrobiologi_air->id) }}"></a>
