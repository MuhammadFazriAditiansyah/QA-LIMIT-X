                            ...
                            <div class="container mt-3">
                                <div class="d-flex justify-content-between align-items-center flex-wrap mb-3">
                                    ...
                                    <div class="d-flex flex-wrap">
                                        <a href="/operator/add_mikrobiologi" class="btn btn-success mr-2 mb-2">
                                            <i class="fa fa-plus"></i> Tambah Data
                                        </a>
                                        <a href="/operator/mikrobiologi/history" class="btn btn-danger mb-2">
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                    @if ($mikrobiologi['statusOP'] == 0)
                                                        <form action="/operator/mikrobiologi/ttd/{{ $mikrobiologi['id'] }}"
                                                ...
                                                <td>
                                                    ...
                                                    @elseif($mikrobiologi['statusST'] == 1)
                                                        ...
                                                        <img src="data:image/png;base64, {!! base64_encode(
                                                            QrCode::format('png')->size(80)->generate($mikrobiologi->user_id_ST . '_' . $mikrobiologi->name_id_ST),
                                                        ) !!}"
                                                            alt="">
                                                ...
                                                <td>
                                                    ...
                                                    @elseif($mikrobiologi['statusSP'] == 1)
                                                        ...
                                                        <img src="data:image/png;base64, {!! base64_encode(
                                                            QrCode::format('png')->size(80)->generate($mikrobiologi->user_id_SP . '_' . $mikrobiologi->name_id_SP),
                                                        ) !!}"
                                                            alt="">
                                                    @endif
                                                </td>
                                                <td align="center">
                                                    <form action="{{ route('mikrobiologi_Delete', $mikrobiologi['id']) }}"
                                                        method="POST">
                                                        @csrf
                                                        {{-- @method('DELETE')  --}}
                                                        @method('PATCH')
                                                        ...
                                                        <a class="fa-solid fa-pen-to-square text-success btn"
                                                            href="{{ route('edit_mikrobiologi', $mikrobiologi->id) }}"></a>

                                                        <br>
                                                        <a class="fa-solid fa-file-pdf ml-1 btn" target="_blank"
                                                            href="{{ route('operator_mikrobiologi_pdf', $mikrobiologi->id) }}"></a>

                                                        <a target="_blank"
                                                            href="{{ route('mikrobiologi_air_excel_show', $mikrobiologi->id) }}">
                                                        ...
                                                        <br>
                                                        <a href="{{ route('mikrobiologi_sampel', $mikrobiologi->id) }}"
