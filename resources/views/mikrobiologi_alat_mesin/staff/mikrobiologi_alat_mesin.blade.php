                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            @if($alat_mesin['statusOP'] == 0)
                                                ...
                                                {{-- {!! QrCode::size(80)->generate($alat_mesin->user_id_OP ."_". $alat_mesin->name_id_OP) !!} --}}
                                            @endif
                                        </td>
                                        <td align="center">
                                            @if($alat_mesin['statusST'] == 0)
                                                <form action="/staff/mikrobiologi_alat_mesin/ttd/{{$alat_mesin['id']}}" method="POST" class="text-center">
                                                    @csrf
                                                    @method('PATCH')
                                                ...
                                                <form action="/staff/mikrobiologi_alat_mesin/declinettd/{{$alat_mesin['id']}}" method="POST" style="margin-top:5%;" class="text-center">
                                                    @csrf
                                                    @method('PATCH')
                                        ...
                                        <td align="center" style="justify-content;center;">
                                            <form action="{{route('delete', $alat_mesin['id'])}}" method="POST" style="text-center">
                                                @csrf
                                                @method('DELETE')
                                                ...
                                                {{-- <a class="fa-solid fa-file-pdf ml-1 btn" target="_blank" href="{{route('staff_analisakimiapdf', $alat_mesin->id)}}"></a> --}}
                                                <a href="{{route('ST_mikrobiologi_alat_mesin_pdf', $alat_mesin->id)}}" target="_blank"><i class="fa-solid fa-file-pdf ml-1 fa-lg"></i></a>
