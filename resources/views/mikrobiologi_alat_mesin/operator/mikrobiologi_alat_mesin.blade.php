                        ...
                        <div class="col-12">
                            <div class="card shadow">
                                ...
                                <div class="button" style="margin-left:4%;">
                                    ...
                                    <a href="/operator/add_mikrobiologi_alat_mesin" class="btn btn-success" style="margin-top: 20px;"><i class="fa fa-plus"></i> Tambah Data</a>

                                    <a href="/operator/mikrobiologi_alat_mesin/history" class="btn btn-danger" style="width:auto; text-align:center; float:right; margin:20px;"><i class="fa fa-history"></i> History Delete</a>
                                  </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        @if($alat_mesin['statusOP'] == 0)
                                                            <form action="/operator/mikrobiologi_alat_mesin/ttd/{{$alat_mesin['id']}}" method="POST" class="text-center">
                                                                @csrf
                                                                @method('PATCH')
                                                    ...
                                                    <td align="center" style="justify-content:center;">
                                                        <form action="{{route('mikrobiologi_alat_mesin_Delete', $alat_mesin['id'])}}" method="POST">
                                                            @csrf
                                                            {{-- @method('DELETE')  --}}
                                                            @method('PATCH')
                                                            ...
                                                            <br>
                                                            <a class="fa-solid fa-pen-to-square text-success btn" href="{{route('edit_mikrobiologi_alat_mesin', $alat_mesin->id)}}"></a>

                                                            <br>
                                                            <a class="fa-solid fa-file-pdf ml-1 btn" target="_blank" href="{{route('OP_mikrobiologi_alat_mesin_pdf', $alat_mesin->id)}}"></a>
                                                            ...
                                                            <br>
                                                            <a href="{{ route('mikrobiologi_alat_mesin_sampel', $alat_mesin->id) }}" class="btn btn-icon icon-left btn-primary"><i class="fa-solid fa-table"></i> Data sampel</a>
