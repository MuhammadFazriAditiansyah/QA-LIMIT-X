    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Analisa Mikrobiologi Alat Dan Mesin</h1>
            </div>

            <div class="section-body">
                <h2 class="section-title">Analisa Mikrobiologi Alat Dan Mesin</h2>
                            ...
                            <div class="container mt-3">
                                <div class="d-flex justify-content-between align-items-center flex-wrap">
                                    ...
                                    <div class="button d-flex align-items-center" style="gap: 10px;">
                                        <a href="/operator/add_mikrobiologi_alat_mesin" class="btn btn-success">
                                            <i class="fa fa-plus"></i> Tambah Data
                                        </a>

                                        <a href="/operator/mikrobiologi_alat_mesin/history" class="btn btn-danger">
                                    ...
                                    <table class="table table-bordered table-md">
                                        ...
                                        @forelse ($mikrobiologi_alat_mesin as $alat_mesin)
                                            <tr>
                                                ...
                                                <td>{{ Carbon\Carbon::parse($alat_mesin->tgl_inokulasi)->translatedFormat('d F Y') }}
                                                </td>
                                                {{-- <td>{{Carbon\Carbon::parse($alat_mesin->tgl_pengamatan)->translatedFormat('d F Y')}}</td> --}}
                                                <td align="center">
                                                    @if ($alat_mesin['statusOP'] == 0)
                                                        <form
                                                            action="/operator/mikrobiologi_alat_mesin/ttd/{{ $alat_mesin['id'] }}"
                                                    ...
                                                    @elseif($alat_mesin['statusOP'] == 1)
                                                        <img src="data:image/png;base64, {!! base64_encode(
                                                            QrCode::format('png')->size(80)->generate($alat_mesin->user_id_OP . '_' . $alat_mesin->name_id_OP),
                                                        ) !!}"
                                                            alt="">
                                                    @endif
                                                ...
                                                <td>
                                                    ...
                                                    @elseif($alat_mesin['statusST'] == 1)
                                                        ...
                                                        <img src="data:image/png;base64, {!! base64_encode(
                                                            QrCode::format('png')->size(80)->generate($alat_mesin->user_id_ST . '_' . $alat_mesin->name_id_ST),
                                                        ) !!}"
                                                            alt="">
                                                ...
                                                <td>
                                                    ...
                                                    @elseif($alat_mesin['statusSP'] == 1)
                                                        ...
                                                        <img src="data:image/png;base64, {!! base64_encode(
                                                            QrCode::format('png')->size(80)->generate($alat_mesin->user_id_SP . '_' . $alat_mesin->name_id_SP),
                                                        ) !!}"
                                                            alt="">
                                                    @endif
                                                </td>
                                                <td align="center" style="justify-content:center;">
                                                    <form
                                                        action="{{ route('mikrobiologi_alat_mesin_Delete', $alat_mesin['id']) }}"
                                                        method="POST">
                                                        @csrf
                                                        {{-- @method('DELETE')  --}}
                                                        @method('PATCH')
                                                        ...
                                                        <a class="fa-solid fa-pen-to-square text-success btn"
                                                            href="{{ route('edit_mikrobiologi_alat_mesin', $alat_mesin->id) }}"></a>

                                                        <br>
                                                        <a class="fa-solid fa-file-pdf ml-1 btn" target="_blank"
                                                            href="{{ route('OP_mikrobiologi_alat_mesin_pdf', $alat_mesin->id) }}"></a>

                                                        <a target="_blank"
                                                            href="{{ route('mikrobiologi_alat_mesin_excel_show', $alat_mesin->id) }}">
                                                        ...
                                                        <br>
                                                        <a href="{{ route('mikrobiologi_alat_mesin_sampel', $alat_mesin->id) }}"
