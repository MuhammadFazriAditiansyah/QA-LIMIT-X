        ...
        <aside id="sidebar-wrapper">
            ...
            <ul class="sidebar-menu mt-5" style="margin-top:3%; ">
                ...
                <li class="dropdown active">
                    <a href="/operator/mikrobiologi_alat_mesin" class="nav-link"><i class="fas fa-solid fa-screwdriver-wrench"></i><span>Mikrobiologi Alat Dan Mesin</span></a>
                </li>
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Tambah Dokumen Mikrobiologi Alat Dan Mesin</h1>
            </div>
            ...
            <div class="section-body">
                <h2 class="section-title">Tambah Dokumen Mikrobiologi Alat Dan Mesin</h2>

                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card">
                                <form action="{{route('mikrobiologi_alat_mesin.post')}}" method="POST">
                                  @csrf
                                    ...
                                    <div class="card-footer">
                                      ...
                                      <a href="/operator/mikrobiologi_alat_mesin" class="btn btn-primary" style="width:30%; text-align:center; margin-top:-5%;">Back</a>
                                    </div>
                                </form>
                            </div>
                        </div>
