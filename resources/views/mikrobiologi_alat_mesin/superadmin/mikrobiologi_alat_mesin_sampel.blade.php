...
@section('content')
    ...
    <div class="content-wrapper" style="margin-top: -43%; ">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1>Data Area Analisa Mikrobiologi Alat Dan Mesin</h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        </section>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="/superadmin/mikrobiologi_alat_mesin/info" class="btn btn-danger btn-sm" style="width:auto; text-align:center;"><i class="fa fa-house"></i> Back</a>
                        ...
                        <table id="example1" class="table table-bordered table-striped" style="margin-bottom:2%;">
                            <thead>
                                <tr>
                                    ...
                                    <th>Nama Objek</th>
                                    <th>Jam Sampling</th>
                                    <th>TPC ({{  $mikrobiologi_alat_mesin->satuan_tpc }})</th>
                                    <th>Yeast & Mold ({{  $mikrobiologi_alat_mesin->satuan_yeast_mold }})</th>
                                    {{-- <th>TPC (cfu/cm<sup>2</sup>)</th> --}}
                                    {{-- <th>Yeast & Mold (cfu/cm<sup>2</sup>)</th> --}}
                                    <th>Coliform ({{ $mikrobiologi_alat_mesin->satuan_coliform }})</th>
                            ...
                            <tbody>
                                @forelse ($sampel_mikrobiologi_alat_mesin as $alat_mesin)
                                    <tr>
                                        ...
                                        {{-- <td>
                                            <a class="fa-solid fa-file-pdf ml-1 btn" target="_blank" href="{{route('superadmin_analisakimiapdf', $alat_mesin->id)}}"></a>
                                            <a href="{{ route('mikrobiologi_sampel', $alat_mesin->id) }}" class="btn btn-icon icon-left btn-primary"><i class="fa-solid fa-table"></i> Data</a>
                                        </td> --}}
                                    </tr>
                                        @empty
                                        <tr>
