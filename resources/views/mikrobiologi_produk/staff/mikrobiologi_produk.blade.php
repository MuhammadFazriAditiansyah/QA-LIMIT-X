                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            @if($mikrobiologi_produk['statusOP'] == 0)
                                                ...
                                                <img src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(70)->generate($mikrobiologi_produk->user_id_OP .'_'. $mikrobiologi_produk->name_id_OP)) !!}" alt="">

                                                {{-- {!! QrCode::size(70)->generate($mikrobiologi_produk->user_id_OP ."_". $mikrobiologi_produk->name_id_OP) !!} --}}
                                            @endif
                                        </td>
                                        <td align="center">
                                            ...
                                            @elseif($mikrobiologi_produk['statusST'] == 1)
                                                <img src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(70)->generate($mikrobiologi_produk->user_id_ST ."_". $mikrobiologi_produk->name_id_ST)) !!}" alt="">
                                        ...
                                        <td>
                                            ...
                                            @elseif($mikrobiologi_produk['statusSP'] == 1)
                                                {{-- {!! QrCode::size(70)->generate($mikrobiologi_produk->user_id_SP ."_". $mikrobiologi_produk->name_id_SP) !!} --}}
                                                <img src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(70)->generate($mikrobiologi_produk->user_id_SP ."_". $mikrobiologi_produk->name_id_SP)) !!}" alt="">
                                        ...
                                        <td align="center">
                                            <form action="{{route('delete', $mikrobiologi_produk['id'])}}" method="POST" style="text-center">
                                                ...
                                                <a target="_blank" href="{{route('mikrobiologi_produk_excel_show', $mikrobiologi_produk->id)}}">
