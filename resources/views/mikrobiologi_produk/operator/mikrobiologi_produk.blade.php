                            ...
                            <div class="container mt-3">
                                <div class="d-flex justify-content-between align-items-center flex-wrap mb-3">
                                    ...
                                    <form method="GET" action="{{ url()->current() }}"
                                        class="form-inline d-flex flex-wrap">
                                    ...
                                    {{-- Button Tambah & History --}}
                                    <div class="d-flex flex-wrap">
                                        <a href="/operator/add_mikrobiologi_produk" class="btn btn-success mr-2 mb-2">
                                            <i class="fa fa-plus"></i> Tambah Data
                                        </a>

                                        <a href="/operator/mikrobiologi_produk/history" class="btn btn-danger mb-2">
                                    ...
                                    <table class="table table-bordered table-md">
                                        ...
                                        @forelse ($mikrobiologi_produk as $mikrobiologi)
                                            <tr>
                                                ...
                                                <td>{{ Carbon\Carbon::parse($mikrobiologi->tgl_produk)->translatedFormat('d F Y') }}
                                                </td>
                                                <td>{{ Carbon\Carbon::parse($mikrobiologi->tgl_inokulasi)->translatedFormat('d F Y') }}
                                                </td>
                                                {{-- <td>{{Carbon\Carbon::parse($mikrobiologi->tgl_pengamatan)->translatedFormat('d F Y')}}</td> --}}
                                                {{-- <td>{{$mikrobiologi->tgl_pengamatan}}</td> --}}
                                                <td align="center">
                                                    @if ($mikrobiologi['statusOP'] == 0)
                                                        <form
                                                            action="/operator/mikrobiologi_produk/ttd/{{ $mikrobiologi['id'] }}"
                                                    ...
                                                    @elseif($mikrobiologi['statusOP'] == 1)
                                                        <img src="data:image/png;base64, {!! base64_encode(
                                                            QrCode::format('png')->size(80)->generate($mikrobiologi->user_id_OP . '_' . $mikrobiologi->name_id_OP),
                                                        ) !!}"
                                                            alt="">
                                                    @endif
                                                ...
                                                <td>
                                                    ...
                                                    @elseif($mikrobiologi_produk['statusST'] == 1)
                                                        ...
                                                        <img src="data:image/png;base64, {!! base64_encode(
                                                            QrCode::format('png')->size(80)->generate($mikrobiologi_produk->user_id_ST . '_' . $mikrobiologi_produk->name_id_ST),
                                                        ) !!}"
                                                            alt="">
                                                ...
                                                <td>
                                                    ...
                                                    @elseif($mikrobiologi_produk['statusSP'] == 1)
                                                        ...
                                                        <img src="data:image/png;base64, {!! base64_encode(
                                                            QrCode::format('png')->size(80)->generate($mikrobiologi_produk->user_id_SP . '_' . $mikrobiologi_produk->name_id_SP),
                                                        ) !!}"
                                                            alt="">
                                                    @endif
                                                </td>
                                                <td align="center">
                                                    <form
                                                        action="{{ route('mikrobiologi_produk_Delete', $mikrobiologi['id']) }}"
                                                        method="POST">
                                                        @csrf
                                                        {{-- @method('DELETE')  --}}
                                                        @method('PATCH')
                                                        ...
                                                        <a class="fa-solid fa-pen-to-square text-success btn"
                                                            href="{{ route('edit_mikrobiologi_produk', $mikrobiologi->id) }}"></a>

                                                        <br>
                                                        <a class="fa-solid fa-file-pdf ml-1 btn" target="_blank"
                                                            href="{{ route('OP_mikrobiologi_produk_pdf', $mikrobiologi->id) }}"></a>
                                                        <a target="_blank"
                                                            href="{{ route('mikrobiologi_produk_excel_show', $mikrobiologi->id) }}">
                                                        ...
                                                        <br>
                                                        <a href="{{ route('mikrobiologi_produk_sampel', $mikrobiologi->id) }}"
