                                  ...
                                  @csrf
                                    ...
                                    <div class="form-row" style="margin-top:1%;">
                                        ...
                                        <div class="form-group col-md-1" align="center">
                                            <label for="tpc">TPC ({{ $mikrobiologi->satuan_tpc }})</label>
                                        </div>
                                        <div class="form-group col-md-2" align="center">
                                            <label for="yeast_mold">Yeast & Mold ({{ $mikrobiologi->satuan_yeast_mold }})</label>
                                        </div>
                                        <div class="form-group col-md-2" align="center">
                                            <label for="coliform">Coliform ({{ $mikrobiologi->satuan_coliform }})</label>
                                        </div>
                                        <div class="form-group col-md-2" align="center">
