            ...
            <div class="main-content">
                <section class="section">
                    ...
                    <div class="section-body">
                        <h2 class="section-title">Data Sampel Analisa Mikrobiologi Produk</h2>
                        <div class="row">
                            <div class="col-12">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-md">
                                                <tr>
                                                    ...
                                                    <th scope="col">TPC ({{ $mikrobiologi_produks->satuan_tpc }})</th>
                                                    <th scope="col">Yeast & Mold ({{ $mikrobiologi_produks->satuan_yeast_mold }})</th>
                                                    <th scope="col">Coliform ({{ $mikrobiologi_produks->satuan_coliform }})</th>
                                                ...
                                                <tr>
                                                    @forelse ($sampel_mikrobiologi_produks as $sampel_mikrobiologi)
                                                        <tr id="{{ $sampel_mikrobiologi->id }}">
                                                            ...
                                                            <td>{{ Carbon\Carbon::parse($sampel_mikrobiologi->exp_date)->translatedFormat('h:i') }}</td>                                                        </td>
                                                            ...
                                                            <td>
                                                                <form action="{{route('sampel_mikrobiologi_produk_Delete', $sampel_mikrobiologi['id'])}}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
