                                        ...
                                        <div class="card-body">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" name="tgl_pengamatan" value="{{ $mikrobiologi_produk['tgl_pengamatan'] }}" class="form-control" id="tgl_pengamatan" placeholder="Masukkan Tanggal Pengamatan">
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="satuan_tpc">Satuan TPC</label>
                                                    <input type="string" name="satuan_tpc" value="{{ $mikrobiologi_produk['satuan_tpc'] }}" class="form-control" id="satuan_tpc" placeholder="Masukkan Satuan TPC">
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="satuan_yeast_mold">Satuan Yeast & Mold</label>
                                                    <input type="string" name="satuan_yeast_mold" value="{{ $mikrobiologi_produk['satuan_yeast_mold'] }}" class="form-control" id="satuan_yeast_mold" placeholder="Masukkan Satuan Yeast & Mold">
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="satuan_coliform">Satuan Coliform</label>
                                                    <input type="string" name="satuan_coliform" value="{{ $mikrobiologi_produk['satuan_coliform'] }}" class="form-control" id="satuan_coliform" placeholder="Masukkan Satuan Coliform">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    {{-- @foreach ($sampel_mikrobiologis as $sampel_mikrobiologi) --}}
                                        ...
                                        <div class="card-body">
                                            <div class="form-row" style="margin-top:-3%;">
                                                ...
                                                <div class="form-group col-md-2" align="center">
                                                    <label for="inputEmail4">TPC({{ $mikrobiologi_produk->satuan_tpc }})</label>
                                                </div>
                                                <div class="form-group col-md-2" align="center">
                                                    <label for="inputEmail4">Yeast & Mold({{ $mikrobiologi_produk->satuan_yeast_mold }})</label>
                                                </div>
                                                <div class="form-group col-md-2" align="center">
                                                    <label for="inputEmail4">Coliform({{ $mikrobiologi_produk->satuan_coliform }})</label>
                                                </div>
                                                <div class="form-group col-md-2" align="center">
                                                ...
                                                <div class="card-body" id="sampel">
                                                    <div class="form-row" style="margin-top:-1%;">
                                                        ...
                                                        <div class="form-group col-md-1" align="center">
                                                            <label for="tpc">TPC ({{ $mikrobiologi_produk->satuan_tpc }})</label>
                                                        </div>
                                                        <div class="form-group col-md-2" align="center">
                                                            <label for="yeast_mold">Yeast & Mold ({{ $mikrobiologi_produk->satuan_yeast_mold }})</label>
                                                        </div>
                                                        <div class="form-group col-md-2" align="center">
                                                            <label for="coliform">Coliform ({{ $mikrobiologi_produk->satuan_coliform }})</label>
                                                        </div>
                                                        <div class="form-group col-md-2" align="center">
