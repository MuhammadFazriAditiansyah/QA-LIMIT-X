                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-md">
                                    ...
                                    @forelse ($mikrobiologi_proses_produksi as $proses_produksi)
                                        <tr>
                                            ...
                                            <td align="center">
                                                @if($proses_produksi['statusOP'] == 0)
                                                    ...
                                                    {{-- {!! QrCode::size(100)->generate($proses_produksi->user_id_OP ."_". $proses_produksi->name_id_OP) !!} --}}
                                            ...
                                            <td align="center">
                                                <form action="{{route('delete', $proses_produksi['id'])}}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    {{-- <button class="text-danger btn"><i class="fa-solid fa-trash"></i></button>
                                                    <br>
                                                    <a class="fa-solid fa-pen-to-square text-success btn" href="{{route('edit', $proses_produksi->id)}}"></a>
                                                    <br>--}}

                                                    {{-- <a class="fa-solid fa-file-pdf ml-1 btn" target="_blank" href="{{route('supervisor_analisakimiapdf', $proses_produksi->id)}}"></a> --}}
                                                    <a href="{{route('SP_mikrobiologi_proses_produksi_pdf', $proses_produksi->id)}}" target="_blank"><i class="fa-solid fa-file-pdf ml-1 fa-lg"></i></a>
                                        ...
                                        @empty
                                            <tr>
                                                <td class="text-center h5" colspan="8" align="center">Not Found</td>
                                            </tr>
                                    @endforelse
                                </table>
