...
@section('content')
      ...
      <div class="main-wrapper main-wrapper-1">
          ...
          <nav class="navbar navbar-expand-lg main-navbar">
            {{-- <form action="{{route('delete', $futami['id'])}}" method="POST"> --}}
                ...
                <form class="form-inline mr-auto" method="GET" action="{{ route('mikrobiologi_proses_produksi_history') }}">
                ...
                <a class="text-success btn" href="/operator/mikrobiologi_proses_produksi/history" style="margin-right:24%;"><i class="fa-solid fa-arrows-rotate fa-lg"></i></a>
          ...
          <div class="main-content">
              <section class="section">
                  <div class="section-header">
                      <h1>History Analisa Mikrobiologi Proses Produksi</h1>
                  </div>

                  <div class="section-body">
                      <h2 class="section-title">History Analisa Mikrobiologi Proses Produksi</h2>
                          ...
                          <div class="col-12">
                              <div class="card shadow">
                                ...
                                <div class="button" style="margin-left:4%; margin-top:3%;">
                                    <a href="/operator/mikrobiologi_proses_produksi" class="btn btn-icon icon-left btn-primary"><i class="fa-solid fa-house"></i> Back</a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-start align-items-center">
                                                        ...
                                                        <form action="{{ route('mikrobiologi_proses_produksi.restore', $proses_produksi->id) }}" method="POST" class="mr-2">
                                                            @csrf
                                                        ...
                                                        <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#confirmDeleteModal-{{ $proses_produksi->id }}">
  ...
  @foreach ($mikrobiologi_proses_produksi as $mikrobiologi)
      ...
      <div class="modal-dialog">
          <div class="modal-content">
              ...
              <div class="modal-footer">
                  ...
                  <form action="{{ route('mikrobiologi_proses_produksi_delete_permanent', $mikrobiologi->id) }}" method="POST">
                      @csrf
                      @method('DELETE')
