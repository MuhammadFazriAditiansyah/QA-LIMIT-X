            ...
            <div class="main-content">
                <section class="section">
                    <div class="section-header">
                        <h1>Data Sampel Analisa Mikrobiologi Proses Produksi</h1>
                    </div>
                    <div class="section-body">
                        <h2 class="section-title">Data Sampel Analisa Mikrobiologi Proses Produksi</h2>
                        <div class="row">
                            <div class="col-12">
                                <div class="card shadow">
                                    ...
                                    @if(Session::get('failedDelete'))
                                        <div class="alert alert-danger w-70">
                                            {{Session::get('failedDelete')}}
                                        </div>
                                    @endif
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-md">
                                                <tr>
                                                    ...
                                                    <th scope="col">TPC ({{ $mikrobiologi_proses_produksi->satuan_tpc }})</th>
                                                    <th scope="col">Yeast & Mold ({{ $mikrobiologi_proses_produksi->satuan_yeast_mold }})</th>
                                                    <th scope="col">Coliform ({{ $mikrobiologi_proses_produksi->satuan_coliform }})</th>
                                                    <th scope="col">Keterangan</th>
                                                    <th scope="col">Action</th>
                                                </tr>
                                                <tr>
                                                    @forelse ($sampel_mikrobiologi_proses_produksi as $proses_produksi)
                                                        <tr id="{{ $proses_produksi->id }}">
                                                            ...
                                                            <td>
                                                                <form action="{{route('sampel_mikrobiologi_proses_produksi_Delete', $proses_produksi['id'])}}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
