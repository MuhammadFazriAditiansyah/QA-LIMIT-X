                        ...
                        <div class="col-12">
                            <div class="card shadow">
                                ...
                                <div class="button" style="margin-left:4%;">
                                    ...
                                    <a href="/operator/add_mikrobiologi_proses_produksi" class="btn btn-success" style="margin-top: 20px;"><i class="fa fa-plus"></i> Tambah Data</a>

                                    <a href="/operator/mikrobiologi_proses_produksi/history" class="btn btn-danger" style="width:auto; text-align:center; float:right; margin:20px;"><i class="fa fa-history"></i> History Delete</a>
                                  </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        @if($proses_produksi['statusOP'] == 0)
                                                            <form action="/operator/mikrobiologi_proses_produksi/ttd/{{$proses_produksi['id']}}" method="POST" class="text-center">
                                                                @csrf
                                                                @method('PATCH')
                                                        ...
                                                        @elseif($proses_produksi['statusOP'] == 1)
                                                            <img src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(80)->generate($proses_produksi->user_id_OP .'_'. $proses_produksi->name_id_OP)) !!}" alt="">
                                                    ...
                                                    <td align="center">
                                                        <form action="{{route('mikrobiologi_proses_produksi_Delete', $proses_produksi['id'])}}" method="POST">
                                                            @csrf
                                                            {{-- @method('DELETE')  --}}
                                                            @method('PATCH')
                                                            ...
                                                            <br>
                                                            <a class="fa-solid fa-pen-to-square text-success btn" href="{{route('edit_mikrobiologi_proses_produksi', $proses_produksi->id)}}"></a>

                                                            <br>
                                                            <a class="fa-solid fa-file-pdf ml-1 btn" target="_blank" href="{{route('OP_mikrobiologi_proses_produksi_pdf', $proses_produksi->id)}}"></a>

                                                            <a target="_blank" href="{{route('mikrobiologi_proses_produksi_excel_show', $proses_produksi->id)}}">
                                                            ...
                                                            <br>
                                                            <a href="{{ route('mikrobiologi_proses_produksi_sampel', $proses_produksi->id) }}" class="btn btn-icon icon-left btn-primary"><i class="fa-solid fa-table"></i> Data sampel</a>
