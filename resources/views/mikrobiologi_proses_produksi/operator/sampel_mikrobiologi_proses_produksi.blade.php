    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Tambah Data Sampel Mikrobiologi Proses Produksi</h1>
            </div>
            ...
            <div class="section-body">
                <h2 class="section-title">Tambah Data Sampel Mikrobiologi Proses Produksi</h2>
                                  ...
                                  @csrf
                                    ...
                                    <div class="form-row" style="margin-top:1%;">
                                        ...
                                        <div class="form-group col-md-2" align="center">
                                            <label for="tpc">TPC ({{$mikrobiologiProsesProduksi->satuan_tpc}})</label>
                                        </div>
                                        <div class="form-group col-md-2" align="center">
                                            <label for="yeast_mold">Yeast & Mold ({{$mikrobiologiProsesProduksi->satuan_yeast_mold}})</label>
                                        </div>
                                        <div class="form-group col-md-2" align="center">
                                            <label for="coliform">Coliform ({{$mikrobiologiProsesProduksi->satuan_coliform}})</label>
                                        </div>
                                        <div class="form-group col-md-2" align="center">
