    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Tambah Dokumen Mikrobiologi Proses Produksi</h1>
            </div>
            ...
            <div class="section-body">
                <h2 class="section-title">Tambah Dokumen Mikrobiologi Proses Produksi</h2>

                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card">
                                <form action="{{route('mikrobiologi_proses_produksi.post')}}" method="POST">
                                  @csrf
                                    <div class="card-body">
                                        <div class="form-row">
                                    ...
                                    <div class="card-footer">
                                      ...
                                      <a href="/operator/mikrobiologi_proses_produksi" class="btn btn-primary" style="width:30%; text-align:center; margin-top:-5%;">Back</a>
                                    </div>
                                </form>
                            </div>
                        </div>
