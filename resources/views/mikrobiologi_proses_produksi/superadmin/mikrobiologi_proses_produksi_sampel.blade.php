            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="/superadmin/mikrobiologi_proses_produksi/info" class="btn btn-danger btn-sm" style="width:auto; text-align:center;"><i class="fa fa-house"></i> Back</a>
                        ...
                        <table id="example1" class="table table-bordered table-striped" style="margin-bottom:2%;">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Sampel</th>
                                    <th>TPC ({{ $mikrobiologi_proses_produksi->satuan_tpc }})</th>
                                    <th>Yeast & Mold ({{ $mikrobiologi_proses_produksi->satuan_yeast_mold }})</th>
                                    <th>Coliform ({{ $mikrobiologi_proses_produksi->satuan_coliform }})</th>
                                    <th>Keterangan (Optional)</th>
                                    {{-- <th align="center">Action</th> --}}
                                </tr>
                            </thead>
                            <tbody>
                                @forelse ($sampel_mikrobiologi_proses_produksi as $sampel_mikrobiologi)
                                    <tr>
                                        <td>{{++$no}}</td>
                                        <td>{{$sampel_mikrobiologi->sampel}}</td>
