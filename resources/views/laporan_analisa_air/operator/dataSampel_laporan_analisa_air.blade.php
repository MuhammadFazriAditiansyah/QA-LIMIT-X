                                        ...
                                        <div class="col-12 col-md-12 col-lg-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h4>Pilih Data Sampel</h4>
                                                </div>
                                                <div class="card-body">
                                                    @foreach ($sampel_null as $sampel)
                                                        <a href="/operator/laporan_analisa_air/sampel/{{ $laporan_analisa_air->id }}/{{$sampel->id}}" class="btn btn-primary m-1">{{ $sampel->sampel }}</a>
                                                    @endforeach
                                                </div>
                                                <div class="card-body">
                                                    @foreach ($data_laporan_analisa_air as $data)
                                                        <a href="/operator/laporan_analisa_air/sampel/{{ $laporan_analisa_air->id }}/{{$data->id}}" class="btn btn-primary m-1">{{ $data->sampel }}</a>
                                                    @endforeach
                                                </div>
                                            </div>
                                        </div>
