                            ...
                            <div class="col-12">
                                <div class="card shadow">
                                    ...
                                    <div class="button" style="margin-left:4%; margin-top:3%;">
                                        <a href="/operator/laporan_analisa_air" class="btn btn-icon icon-left btn-danger"><i class="fa-solid fa-house"></i> Back</a>
                                    </div>
                                        ...
                                        <div class="col-12 col-md-12 col-lg-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h4>Pilih Data Sampel yang akan di Edit</h4>
                                                </div>
                                                <div class="card-body">
                                                    @foreach ($sampel_null as $sampel)
                                                        <a href="/operator/laporan_analisa_air/edit/{{ $laporan_analisa_air->id }}/{{$sampel->id}}" class="btn btn-primary m-1">{{ $sampel->sampel }}</a>
                                                    @endforeach
                                                </div>
                                                <div class="card-body">
                                                    @foreach ($data_laporan_analisa_air as $data)
                                                        <a href="/operator/laporan_analisa_air/edit/{{ $laporan_analisa_air->id }}/{{$data->id}}" class="btn btn-primary m-1">{{ $data->sampel }}</a>
                                                    @endforeach
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <tr>
                                                    @forelse ($sampel_mikrobiologi_kimia_sensori as $kimia_sensori)
                                                        <tr id="{{ $kimia_sensori->id }}">
                                                            ...
                                                            <td>
                                                                <form action="{{route('sampel_mikrobiologi_kimia_sensori_Delete', $kimia_sensori['id'])}}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
