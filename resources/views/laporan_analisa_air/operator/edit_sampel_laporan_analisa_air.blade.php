    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Edit Data Sampel Laporan Analisa Air</h1>
            </div>
            ...
            <div class="section-body">
                <h2 class="section-title">Edit Data Sampel {{$sampel_null->sampel}}</h2>
                        ...
                        <div class="card">
                            <div class="card">
                                {{-- <div class="col-12 col-md-6 col-lg-6">
                                    ...
                                    @if ($sampel_id > 8)
                                        <form action="{{route('update_laporan_analisa_air.post', ['id'=>$id, 'sampel_id'=>$sampel_id])}}" method="POST">
                                            @csrf
                                            @method('PATCH')


                                            @foreach ($sampel_laporan_analisa_air as $key => $sampel)
                                                <div class="form-row" style="margin-top:1%; padding:10px;">
                                                    <div class="form-group col-md-4" align="center">
                                                        <label for="pengujian">Pengujian</label>
                                                        <select class="form-control select2" name="inputSampel[{{ $key }}][pengujian]" placeholder="-- pengujian --">
                                                    ...
                                                    <div class="form-group col-md-2" align="center">
                                                        ...
                                                        <input type="text" name="inputSampel[{{ $key }}][shift_1]" value="{{$sampel->shift_1}}" class="form-control" id="shift_1" placeholder="Masukkan shift 1">
                                                    </div>
                                                    <div class="form-group col-md-2" align="center">
                                                        <label for="shift_2">Shift 2</label>
                                                        <input type="text" name="inputSampel[{{ $key }}][shift_2]" value="{{$sampel->shift_2}}" class="form-control" id="shift_2" placeholder="Masukkan shift 2">
                                                    </div>
                                                    <div class="form-group col-md-3" align="center">
                                                        <label for="keterangan">Keterangan</label>
                                                        <input type="text" name="inputSampel[{{ $key }}][keterangan]" value="{{$sampel->keterangan}}" class="form-control" id="keterangan" placeholder="Masukkan keterangan">
                                                    </div>
                                            ...
                                            <div class="card-footer">
                                                <a href="/operator/laporan_analisa_air/edit/{{$id}}" class="btn btn-icon icon-left btn-danger"><i class="fas fa-arrow-left"></i> Back</a>
                            ...
                            <div class="card">
                                ...
                                @else
                                    <form action="{{route('sampel_laporan_analisa_air.post', ['id'=>$id, 'sampel_id'=>$sampel_id])}}" method="POST">
                                        ...
                                        <div class="card-footer">
                                            <a href="/operator/laporan_analisa_air/edit/{{$id}}"  id="alertEditSampel" class="btn btn-icon icon-left btn-danger"><i class="fas fa-arrow-left"></i> Back</a>
                                            <button type="submit" class="btn btn-primary" style="width:30%; text-align:center; margin-left:70%; margin-top:-9%;">Simpan sampel</button>
                                        </div>
                                    </form>
                                @endif
