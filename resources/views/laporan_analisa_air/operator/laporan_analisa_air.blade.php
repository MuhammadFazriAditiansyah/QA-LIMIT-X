                        ...
                        <div class="col-12">
                            <div class="card shadow">
                                ...
                                <div class="button" style="margin-left:4%;">
                                    ...
                                    <a href="/operator/add_laporan_analisa_air" class="btn btn-success" style="margin-top: 20px;"><i class="fa fa-plus"></i> Tambah Data</a>

                                    <a href="/operator/laporan_analisa_air/history" class="btn btn-danger" style="width:auto; text-align:center; float:right; margin:20px;"><i class="fa fa-history"></i> History Delete</a>
                                  </div>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                    @if($analisa_air['statusOP'] == 0)
                                                        <form action="/operator/laporan_analisa_air/ttd/{{$analisa_air['id']}}" method="POST" class="text-center">
                                                            @csrf
                                                            @method('PATCH')
                                                    ...
                                                    @elseif($analisa_air['statusOP'] == 1)
                                                        <img src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(70)->generate($analisa_air->user_id_OP .'_'. $analisa_air->name_id_OP)) !!}" alt="">
                                                ...
                                                <td>
                                                    ...
                                                    @elseif($analisa_air['statusST'] == 1)
                                                        ...
                                                        <img src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(70)->generate($analisa_air->user_id_ST ."_". $analisa_air->name_id_ST)) !!}" alt="">
                                                ...
                                                <td>
                                                    ...
                                                    @elseif($analisa_air['statusSP'] == 1)
                                                        ...
                                                        <img src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(70)->generate($analisa_air->user_id_SP ."_". $analisa_air->name_id_SP)) !!}" alt="">
                                                    @endif
                                                </td>
                                                <td align="center" style="justify-content:center;">
                                                    <form action="{{route('laporan_analisa_air_Delete', $analisa_air['id'])}}" method="POST">
                                                        @csrf
                                                        @method('PATCH')
                                                        <button class="text-danger btn"><i class="fa-solid fa-trash"></i></button>

                                                        <br>
                                                        <a class="fa-solid fa-pen-to-square text-success btn" href="{{route('edit_laporan_analisa_air', $analisa_air->id)}}"></a>

                                                        <br>
                                                        <a class="fa-solid fa-file-pdf ml-1 btn" target="_blank" href="{{route('OP_laporan_analisa_air_pdf', $analisa_air->id)}}"></a>
                                                        ...
                                                        <br>
                                                        <a href="{{ route('laporan_analisa_air_sampel', $analisa_air->id) }}" class="btn btn-icon icon-left btn-primary"><i class="fa-solid fa-table"></i> Data sampel</a>
