                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                                @if($analisa_air['statusOP'] == 0)
                                                    ...
                                                    {{-- {!! QrCode::size(100)->generate($analisa_air->user_id_OP ."_". $analisa_air->name_id_OP) !!} --}}
                                            ...
                                            <td>
                                                ...
                                                @elseif($analisa_air['statusST'] == 1)
                                                    {{-- {!! QrCode::size(80)->generate($analisa_air->user_id_ST ."_". $analisa_air->name_id_ST) !!} --}}
                                                ...
                                                @elseif($analisa_air['statusST'] == 2)
                                                    <div class="alert alert-danger" style="text-align: center; width:100px;">Ditolak</div>
                                                @endif
                                            </td>
                                            <td>
                                              ...
                                              @elseif($analisa_air['statusSP'] == 1)
                                                {{-- {!! QrCode::size(80)->generate($analisa_air->user_id_SP ."_". $analisa_air->name_id_SP) !!} --}}
                                            ...
                                            <td>
                                                <form action="{{route('delete', $analisa_air['id'])}}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    ...
                                                    {{-- <a class="fa-solid fa-file-pdf ml-1 btn" target="_blank" href="{{route('supervisor_analisakimiapdf', $analisa_air->id)}}"></a> --}}
                                                    <a href="{{route('SP_laporan_analisa_air_pdf', $analisa_air->id)}}" target="_blank"><i class="fa-solid fa-file-pdf ml-1 fa-lg"></i></a>
