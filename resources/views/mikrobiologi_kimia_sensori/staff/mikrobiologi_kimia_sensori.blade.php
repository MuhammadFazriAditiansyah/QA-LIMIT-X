   ...
   <div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Data Pemeriksaan Kimia Sensori</h1>
        </div>

        <div class="section-body">
            <h2 class="section-title">Data Pemeriksaan Kimia Sensori</h2>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            @if($kimia_sensori['statusOP'] == 0)
                                                ...
                                                {{-- {!! QrCode::size(80)->generate($kimia_sensori->user_id_OP ."_". $kimia_sensori->name_id_OP) !!} --}}
                                            @endif
                                        </td>
                                        <td align="center">
                                            @if($kimia_sensori['statusST'] == 0)
                                                <form action="/staff/mikrobiologi_kimia_sensori/ttd/{{$kimia_sensori['id']}}" method="POST" class="text-center">
                                                    @csrf
                                                    @method('PATCH')
                                                ...
                                                <form action="/staff/mikrobiologi_kimia_sensori/declinettd/{{$kimia_sensori['id']}}" method="POST" style="margin-top:5%;" class="text-center">
                                                    @csrf
                                                    @method('PATCH')
                                        ...
                                        <td align="center" style="justify-content;center;">
                                            <form action="{{route('delete', $kimia_sensori['id'])}}" method="POST" style="text-center">
                                                @csrf
                                                @method('DELETE')
                                                ...
                                                {{-- <a class="fa-solid fa-file-pdf ml-1 btn" target="_blank" href="{{route('staff_analisakimiapdf', $kimia_sensori->id)}}"></a> --}}
                                                <a href="{{route('ST_mikrobiologi_kimia_sensori_pdf', $kimia_sensori->id)}}" target="_blank"><i class="fa-solid fa-file-pdf ml-1 fa-lg"></i></a>
