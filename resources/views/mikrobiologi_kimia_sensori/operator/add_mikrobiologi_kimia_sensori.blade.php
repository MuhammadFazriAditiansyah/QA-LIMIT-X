                ...
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu mt-5" style="margin-top:3%; ">
                        ...
                        <li class="dropdown active">
                            <a href="/operator/mikrobiologi_kimia_sensori" class="nav-link"><i
                                    class="fas fa-solid fa-atom"></i><span>Pemeriksaan Kimia Dan Sensori</span></a>
                        </li>
            ...
            <div class="main-content">
                <section class="section">
                    <div class="section-header">
                        <h1>Tambah Dokumen Pemeriksaan Kimia Dan Sensori</h1>
                    </div>
                    ...
                    <div class="section-body">
                        <h2 class="section-title">Tambah Dokumen Pemeriksaan Kimia Dan Sensori</h2>

                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card">
                                        <form action="{{ route('mikrobiologi_kimia_sensori.post') }}" method="POST">
                                            @csrf
                                            ...
                                            <div class="card-body">
                                                <div class="form-row">
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input type="string" name="nodokumen" class="form-control"
                                                            id="nodokumen" placeholder="Masukkan No.Dokumen">
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                        <label for="tgl_produksi">Tanggal Produksi</label>
                                                        <input type="date" name="tgl_produksi" class="form-control"
                                                            id="tgl_produksi" placeholder="Masukkan Tanggal Produksi">
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                        <label for="nama_produk">Nama Produk</label>
                                                        <input type="string" name="nama_produk" class="form-control"
                                                            id="nama_produk" placeholder="Masukkan Nama Produk">
                                                    </div>
                                                    <div class="form-group col-md-3">
                                                        <label for="jumlah_batch">Jumlah Batch</label>
                                                        <input type="string" name="jumlah_batch" class="form-control"
                                                            id="jumlah_batch" placeholder="Masukkan Jumlah Batch">
                                                    </div>
                                                    <div class="form-group col-md-3">
                                                        <label for="keterangan">Keterangan</label>
                                                        <input type="string" name="keterangan" class="form-control"
                                            ...
                                            <div class="card-footer">
                                                <button class="btn btn-success"
                                                    style="width:30%; text-align:center; margin-left:70%; margin-top:-2%;">Simpan
                                                    Data</button>
                                                <a href="/operator/mikrobiologi_kimia_sensori" class="btn btn-primary"
                                                    style="width:30%; text-align:center; margin-top:-5%;">Back</a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
