            ...
            <div class="main-content">
                <section class="section">
                    <div class="section-header">
                        <h1>Data Analisa Pemeriksaan Kimia Dan Sensori</h1>
                    </div>
                    <div class="section-body">
                        <h2 class="section-title">Data Analisa Pemeriksaan Kimia Dan Sensori</h2>
                        <div class="row">
                            <div class="col-12">
                                <div class="card shadow">
                                    ...
                                    <div class="button" style="margin-left:4%; margin-top:3%;">
                                        <a href="/operator/mikrobiologi_kimia_sensori" class="btn btn-icon icon-left btn-primary"><i class="fa-solid fa-house"></i> Back</a>
                                    </div>
