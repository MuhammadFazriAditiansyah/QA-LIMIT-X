                        ...
                        <div class="card shadow">
                            ...
                            <div class="container mt-3">
                                ...
                                <div class="button d-flex align-items-center" style="gap: 10px;">
                                    <a href="/operator/add_mikrobiologi_kimia_sensori" class="btn btn-success"
                                        style="margin-top: 0;">
                                        <i class="fa fa-plus"></i> Tambah Data
                                    </a>

                                    <a href="/operator/mikrobiologi_kimia_sensori/history" class="btn btn-danger"
                                    ...
                                    <table class="table table-bordered table-md">
                                        ...
                                        @forelse ($mikrobiologi_kimia_sensori as $kimia_sensori)
                                            <tr>
                                                ...
                                                <td>{{ Carbon\Carbon::parse($kimia_sensori->tgl_produksi)->translatedFormat('d F Y') }}
                                                </td>
                                                ...
                                                <td align="center">
                                                    @if ($kimia_sensori['statusOP'] == 0)
                                                        <form
                                                            action="/operator/mikrobiologi_kimia_sensori/ttd/{{ $kimia_sensori['id'] }}"
                                                    ...
                                                    @elseif($kimia_sensori['statusOP'] == 1)
                                                        <img src="data:image/png;base64, {!! base64_encode(
                                                            QrCode::format('png')->size(70)->generate($kimia_sensori->user_id_OP . '_' . $kimia_sensori->name_id_OP),
                                                        ) !!}"
                                                            alt="">
                                                    @endif
                                                ...
                                                <td>
                                                    ...
                                                    @elseif($kimia_sensori['statusST'] == 1)
                                                        ...
                                                        <img src="data:image/png;base64, {!! base64_encode(
                                                            QrCode::format('png')->size(70)->generate($kimia_sensori->user_id_ST . '_' . $kimia_sensori->name_id_ST),
                                                        ) !!}"
                                                            alt="">
                                                ...
                                                <td>
                                                    ...
                                                    @elseif($kimia_sensori['statusSP'] == 1)
                                                        ...
                                                        <img src="data:image/png;base64, {!! base64_encode(
                                                            QrCode::format('png')->size(70)->generate($kimia_sensori->user_id_SP . '_' . $kimia_sensori->name_id_SP),
                                                        ) !!}"
                                                            alt="">
                                                    @endif
                                                </td>
                                                <td align="center" style="justify-content:center;">
                                                    <form
                                                        action="{{ route('mikrobiologi_kimia_sensori_Delete', $kimia_sensori['id']) }}"
                                                        method="POST">
                                                        @csrf
                                                        {{-- @method('DELETE')  --}}
                                                        @method('PATCH')
                                                        ...
                                                        <a class="fa-solid fa-pen-to-square text-success btn"
                                                            href="{{ route('edit_mikrobiologi_kimia_sensori', $kimia_sensori->id) }}"></a>

                                                        <br>
                                                        <a class="fa-solid fa-file-pdf ml-1 btn" target="_blank"
                                                            href="{{ route('OP_mikrobiologi_kimia_sensori_pdf', $kimia_sensori->id) }}"></a>

                                                        <a target="_blank"
                                                            href="{{ route('mikrobiologi_kimia_sensori_excel_show', $kimia_sensori->id) }}">
                                                        ...
                                                        <br>
                                                        <a href="{{ route('mikrobiologi_kimia_sensori_sampel', $kimia_sensori->id) }}"
