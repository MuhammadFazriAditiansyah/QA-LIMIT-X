        ...
        <div class="main-content">
            <section class="section">
                <div class="section-header">
                    <h1>Pemeriksaan Kimia Dan Sensori</h1>
                </div>

                <div class="section-body">
                    <h2 class="section-title">Pemeriksaan Kimia Dan Sensori</h2>
                        ...
                        <div class="col-12">
                            <div class="card shadow">
                                ...
                                <div class="button" style="margin-left:4%;">
                                    ...
                                    <a href="/operator/add_mikrobiologi_kimia_sensori" class="btn btn-success" style="margin-top: 20px;"><i class="fa fa-plus"></i> Tambah Data</a>

                                    <a href="/operator/mikrobiologi_kimia_sensori/history" class="btn btn-danger" style="width:auto; text-align:center; float:right; margin:20px;"><i class="fa fa-history"></i> History Delete</a>
                                  </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        @if($kimia_sensori['statusOP'] == 0)
                                                            <form action="/operator/mikrobiologi_kimia_sensori/ttd/{{$kimia_sensori['id']}}" method="POST" class="text-center">
                                                                @csrf
                                                                @method('PATCH')
                                                        ...
                                                        @elseif($kimia_sensori['statusOP'] == 1)
                                                            <img src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(70)->generate($kimia_sensori->user_id_OP .'_'. $kimia_sensori->name_id_OP)) !!}" alt="">
                                                    ...
                                                    <td>
                                                        ...
                                                        @elseif($kimia_sensori['statusST'] == 1)
                                                            {{-- {!! QrCode::size(70)->generate($kimia_sensori->user_id_ST ."_". $kimia_sensori->name_id_ST) !!} --}}
                                                            <img src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(70)->generate($kimia_sensori->user_id_ST ."_". $kimia_sensori->name_id_ST)) !!}" alt="">
                                                    ...
                                                    <td>
                                                        ...
                                                        @elseif($kimia_sensori['statusSP'] == 1)
                                                            {{-- {!! QrCode::size(70)->generate($kimia_sensori->user_id_SP ."_". $kimia_sensori->name_id_SP) !!} --}}
                                                            <img src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(70)->generate($kimia_sensori->user_id_SP ."_". $kimia_sensori->name_id_SP)) !!}" alt="">
                                                        @endif
                                                    </td>
                                                    <td align="center" style="justify-content:center;">
                                                        <form action="{{route('mikrobiologi_kimia_sensori_Delete', $kimia_sensori['id'])}}" method="POST">
                                                            @csrf
                                                            {{-- @method('DELETE')  --}}
                                                            @method('PATCH')
                                                            ...
                                                            <br>
                                                            <a class="fa-solid fa-pen-to-square text-success btn" href="{{route('edit_mikrobiologi_kimia_sensori', $kimia_sensori->id)}}"></a>

                                                            <br>
                                                            <a class="fa-solid fa-file-pdf ml-1 btn" target="_blank" href="{{route('OP_mikrobiologi_kimia_sensori_pdf', $kimia_sensori->id)}}"></a>
                                                            ...
                                                            <br>
                                                            <a href="{{ route('mikrobiologi_kimia_sensori_sampel', $kimia_sensori->id) }}" class="btn btn-icon icon-left btn-primary"><i class="fa-solid fa-table"></i> Data sampel</a>
