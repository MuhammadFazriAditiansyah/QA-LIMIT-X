                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($futami['statusOP'] == 0)
                                                        ...
                                                        {{-- <img src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(70)->generate($futami->user_id_OP .'_'. $futami->name_id_OP)) !!}" alt=""> --}}

                                                        {!! QrCode::size(70)->generate($futami->user_id_OP ."_". $futami->name_id_OP) !!}
                                                    @endif
                                                </td>
                                                <td>
                                                    ...
                                                    {{-- {{ $futami->user_id_ST }} _ {{ $futami->name_id_ST }} --}}
                                                        ...
                                                        {{-- <img src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(70)->generate($futami->user_id_ST ."_". $futami->name_id_ST)) !!}" alt=""> --}}
                                                        {!! QrCode::size(70)->generate($futami->user_id_ST ."_". $futami->name_id_ST) !!}
                                                ...
                                                <td>
                                                    ...
                                                    @elseif($futami['statusSP'] == 1)
                                                        {!! QrCode::size(70)->generate($futami->user_id_SP ."_". $futami->name_id_SP) !!}
                                                    @endif
                                                </td>
                                                <td>
                                                    <form action="{{route('delete', $futami['id'])}}" method="POST" style="text-center">
                                                        ...
                                                        <a target="_blank" href="{{route('staff_analisakimia_excel_show', $futami->id)}}">
