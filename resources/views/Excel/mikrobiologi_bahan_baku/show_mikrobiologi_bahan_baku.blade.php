...
<head>
    ...
    <title>Analisa Mikrobiologi Bahan Baku {{$mikrobiologi_bahan_baku->nodokumen}}</title>
    <style>
        @page {
            margin-left: 0.1in;
            margin-right: 0.1in;
...
<body style="padding:40px;">
    ...
    <div class="export-excel" style="padding: 10px; float: right; background-color: rgb(0, 213, 0); margin-top: 10px; border-radius: 5px;">
        <a href="/mikrobiologi_bahan_baku/exportExcel/{{ $mikrobiologi_bahan_baku->id }}" onclick="hideLogoImage()" style="color: rgb(255, 255, 255); text-decoration: none;">Export</a>
    </div>
</body>
</html>
