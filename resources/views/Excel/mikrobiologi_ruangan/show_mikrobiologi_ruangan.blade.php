...
<head>
    ...
    <title>Analisa Mikrobiologi Ruangan {{$mikrobiologi_ruangan->nodokumen}}</title>
    <style>
        @page {
            margin-left: 0.1in;
            margin-right: 0.1in;
...
<body style="padding:40px;">
            ...
            <td style="border-bottom-style:hidden;">
                ...
                <table width="98%" style="margin:10px;">
                    <tr>
                        ...
                        <td colspan="2">FFB/FRM/QA/18/09</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="5" align="center" style="font-weight:bold;">LAPORAN ANALISA MIKROBIOLOGI RUANGAN</td>
            ...
            <td>
                <table width="100%" style="margin: 10px 30px 10px 30px;">
                    <tr style="border-style:hidden;">
                        ...
                        <td colspan="9">{{ $mikrobiologi_ruangan->nodokumen }}</td>
                    </tr>
                    <tr style="border-style: hidden;">
                        <td colspan="2">Tgl Inokulasi</td>
                        <td align="center" style="border-style: hidden;">:</td>
                        <td colspan="9">
                            {{ Carbon\Carbon::parse($mikrobiologi_ruangan->tgl_inokulasi)->translatedFormat('d F Y') }}
                        </td>
                    </tr>
                    <tr style="border-style:hidden;">
                        <td colspan="2">Tgl pengamatan</td>
                        <td align="center" style="border-style: hidden;">:</td>
                        <td colspan="9">{{ $mikrobiologi_ruangan->tgl_pengamatan }}</td>
                    </tr>
                </table>
            </td>
        </tr>
            ...
            <td style="border-top-style: hidden;">
                <table width="98%" style="margin: 10px;">
                    <tr>
                        ...
                        <td colspan="3" align="center">Area</td>
                        <td colspan="3" align="center">TPC ({{ $mikrobiologi_ruangan->satuan_tpc }})</td>
                        <td colspan="2" align="center">Yeast Mold ({{ $mikrobiologi_ruangan->satuan_yeast_mold }})</td>
                        <td colspan="3" align="center">Keterangan</td>
                    </tr>
                    @foreach ($sampel_mikrobiologi_ruangan as $ruangan)
                        <tr>
                            <td align="center">{{ $loop->iteration }}</td>
                            <td colspan="3" align="center">{{ $ruangan->area }}</td>
                            <td colspan="3" align="center">{{ $ruangan->tpc }}</td>
                            <td colspan="2" align="center">{{ $ruangan->yeast_mold }}</td>
                            <td colspan="3" align="center">{{ $ruangan->keterangan }}</td>
                        </tr>
                    @endforeach
                </table>
            </td>
    ...
    <div class="export-excel" style="padding: 10px; float: right; background-color: rgb(0, 213, 0); margin-top: 10px; border-radius: 5px;">
        <a href="/mikrobiologi_ruangan/exportExcel/{{ $mikrobiologi_ruangan->id }}" onclick="hideLogoImage()" style="color: rgb(255, 255, 255); text-decoration: none;">Export</a>
    </div>
</body>
</html>
