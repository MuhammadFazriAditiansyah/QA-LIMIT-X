            ...
            <td>
                <table width="100%">
                    <tr>
                        ...
                        <td align="center">:</td>
                        <td colspan="3">{{ $futami->nodokumen }}</td>
                        <td style="border-left-style:none;"></td>
                        <td colspan="2">Tanggal Terima Sampel</td>
                        <td align="center">:</td>
                        <td colspan="2">
                    ...
                    <tr>
                        <td colspan="2">Pemberi Sampel</td>
                        <td align="center">:</td>
                        <td colspan="3">{{$futami->pemberi_sampel}}</td>
                        <td></td>
                        <td colspan="2">Jumlah Sampel</td>
                        <td align="center">:</td>
                        <td colspan="2">{{ $futami->jumlah_sampel }}</td>
                    </tr>
                    <tr>
                        <td colspan="2">Parameter Pengujian</td>
                        <td align="center">:</td>
                        <td colspan="3">{{ $futami->parameter_pengujian }}</td>
                        <td></td>
                        <td colspan="2">Tanggal Uji</td>
                        <td align="center">:</td>
                        <td colspan="2">
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td colspan="2">Tgl Selesai uji</td>
                        <td align="center">:</td>
                        <td colspan="2">
            ...
            <td>
                <table width="100%">
                    <tr align="center" style="font-weight:bold;">
                        ...
                        <td rowspan="2" colspan="3"  style="font-weight:bold;">Sampel</td>
                        <td colspan="4" style="font-weight:bold;">Parameter dan Nilai Uji</td>
                        <td colspan="2" rowspan="2" style="font-weight:bold;">Spesifikasi</td>
                        <td colspan="2" rowspan="2" style="font-weight:bold;">Keterangan</td>
                    </tr>
                    <tr align="center" style="font-weight:bold;">
                        <td style="font-weight:bold;">{{ $futami->parameter_pengujian }}</td>
                        <td style="font-weight:bold;">{{ $futami->parameter_pengujian_c2 }}</td>
                        <td style="font-weight:bold;">{{ $futami->parameter_pengujian_c3 }}</td>
                        <td style="font-weight:bold;">{{ $futami->parameter_pengujian_c4 }}</td>
                    </tr>
