    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Tambah Data Mikrobiologi Ruangan</h1>
            </div>
            ...
            <div class="section-body">
                <h2 class="section-title">Tambah Data Mikrobiologi Ruangan</h2>
                <div class="row shadow">
                    <div class="col-12">
                        <div class="card">
                            <div class="card">
                                <form action="{{route('sampel_mikrobiologi_ruangan', $id)}}" method="POST">
                                  @csrf
    ...
    $('#addSampel').click(function(){
        if(i < maxInput){
            ...
            <div class="card-body removeSampel" id="removeSampel" style="margin-top: -5%; margin-left:-25px;">
                ...
                <div class="form-row" style="margin-top:1%;">
                    <div class="form-group col-md-3">
                        <input type="text" name="inputSampel[${i}][area]" class="form-control" id="area" placeholder="Masukkan Kode sampling">
                    </div>
                    <div class="form-group col-md-2">
