    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Tambah Dokumen Mikrobiologi Ruangan</h1>
            </div>
            ...
            <div class="section-body">
                <h2 class="section-title">Tambah Dokumen Mikrobiologi Ruangan</h2>

                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card">
                                <form action="{{route('mikrobiologi_ruangan.post')}}" method="POST">
                                  @csrf
                                    ...
                                    <div class="card-footer">
                                      ...
                                      <a href="/operator/mikrobiologi_ruangan" class="btn btn-primary" style="width:30%; text-align:center; margin-top:-5%;">Back</a>
                                    </div>
                                </form>
                            </div>
                        </div>
