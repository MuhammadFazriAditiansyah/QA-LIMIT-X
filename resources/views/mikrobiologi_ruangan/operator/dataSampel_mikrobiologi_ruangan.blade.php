                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-md">
                                                <tr>
                                                    ...
                                                    <th scope="col">TPC ({{ $mikrobiologi_ruangan->satuan_tpc }})</th>
                                                    <th scope="col">Yeast & Mold ({{ $mikrobiologi_ruangan->satuan_yeast_mold }})</th>
                                                ...
                                                <tr>
                                                    @forelse ($sampel_mikrobiologi_ruangan as $ruangan)
                                                        <tr id="{{ $ruangan->id }}">
                                                            ...
                                                            <td>
                                                                <form action="{{route('sampel_mikrobiologi_ruangan_Delete', $ruangan['id'])}}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
