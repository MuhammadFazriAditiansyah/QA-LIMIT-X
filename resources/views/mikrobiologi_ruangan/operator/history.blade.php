...
@section('content')
      ...
      <div class="main-wrapper main-wrapper-1">
          ...
          <nav class="navbar navbar-expand-lg main-navbar">
            {{-- <form action="{{route('delete', $futami['id'])}}" method="POST"> --}}
                ...
                <form class="form-inline mr-auto" method="GET" action="{{ route('mikrobiologi_ruangan_history') }}">
                ...
                <a class="text-success btn" href="/operator/mikrobiologi_ruangan/history" style="margin-right:24%;"><i class="fa-solid fa-arrows-rotate fa-lg"></i></a>
                  ...
                  <div class="sidebar-brand sidebar-brand-sm ">
                    ...
                    <ul class="sidebar-menu mt-5" style="margin-top:3%; ">
                      ...
                      <li class="dropdown active">
                          <a href="/operator/mikrobiologi_ruangan" class="nav-link"><i class="fas fa-bottle-droplet"></i><span>Mikrobiologi Ruangan</span></a>
                      </li>
          ...
          <div class="main-content">
              <section class="section">
                  ...
                  <div class="section-body">
                      <h2 class="section-title">History Analisa Mikrobiologi Ruangan</h2>
                          ...
                          <div class="col-12">
                              <div class="card shadow">
                                ...
                                <div class="button" style="margin-left:4%; margin-top:3%;">
                                    <a href="/operator/mikrobiologi_ruangan" class="btn btn-icon icon-left btn-primary"><i class="fa-solid fa-house"></i> Back</a>
                                ...
                                <div class="card-body mt-3 shadow">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-md">
                                                  ...
                                                  <tr>
                                                      ...
                                                      <td>
                                                        <div class="d-flex justify-content-start align-items-center">
                                                            ...
                                                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#confirmDeleteModal-{{ $ruangan->id }}">
                                                      ...
                                                      {{-- <td align="center">
                                                        @if($ruangan['statusOP'] == 0)
                                                          <form action="/operator/ruangan/ttd/{{$ruangan['id']}}" method="POST" class="text-center">
                                                            @csrf
                                                            @method('PATCH')
                                                        ...
                                                        @elseif($ruangan['statusOP'] == 1)
                                                          <img src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(100)->generate($ruangan->user_id_OP .'_'. $ruangan->name_id_OP)) !!}" alt="">

                                                        @endif

                                                      </td> --}}
                                                      {{-- <td>
                                                          <form action="{{route('mikrobiologi_Delete', $ruangan['id'])}}" method="POST">
                                                              @csrf
                                                              @method('PATCH')
                                                              ...
                                                              <br>
                                                              <a class="fa-solid fa-pen-to-square text-success btn" href="{{route('edit_mikrobiologi', $ruangan->id)}}"></a>

                                                              <br>
                                                              <a class="fa-solid fa-file-pdf ml-1 btn" target="_blank" href="{{route('operator_mikrobiologi_pdf', $ruangan->id)}}"></a>
                                                              <br>
                                                              <a href="{{ route('mikrobiologi_sampel', $ruangan->id) }}" class="btn btn-icon icon-left btn-primary"><i class="fa-solid fa-table"></i> Data sampel</a>
                                                          </form>
                                                      </td> --}}
                                                  </tr>
                                          ...
                                          {{-- {{ $mikrobiologi_ruangan->links('pagination::bootstrap-4') }} --}}
                                        </div>
                                </div>
                              </div>
                          </div>
  ...
  @foreach ($mikrobiologi_ruangan as $mikrobiologi)
      ...
      <div class="modal-dialog">
          <div class="modal-content">
              ...
              <div class="modal-footer">
                  ...
                  <form action="{{ route('mikrobiologi_ruangan_delete_permanent', $mikrobiologi->id) }}" method="POST">
                      @csrf
                      @method('DELETE')
