   ...
   <div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">Data Analisa Mikrobiologi Ruangan</h2>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            @if($ruangan['statusOP'] == 0)
                                                ...
                                                {{-- {!! QrCode::size(80)->generate($ruangan->user_id_OP ."_". $ruangan->name_id_OP) !!} --}}
                                            @endif
                                        </td>
                                        <td align="center">
                                            @if($ruangan['statusST'] == 0)
                                                <form action="/staff/mikrobiologi_ruangan/ttd/{{$ruangan['id']}}" method="POST" class="text-center">
                                                    @csrf
                                                    @method('PATCH')
                                                ...
                                                <form action="/staff/mikrobiologi_ruangan/declinettd/{{$ruangan['id']}}" method="POST" style="margin-top:5%;" class="text-center">
                                                    @csrf
                                                    @method('PATCH')
                                        ...
                                        <td align="center" style="justify-content;center;">
                                            <form action="{{route('delete', $ruangan['id'])}}" method="POST" style="text-center">
                                                @csrf
                                                @method('DELETE')
                                                {{-- <button class="text-danger btn"><i class="fa-solid fa-trash"></i></button>
                                                <br>
                                                <a class="fa-solid fa-pen-to-square text-success btn" href="{{route('edit', $ruangan->id)}}"></a>
                                                <br>--}}

                                                {{-- <a class="fa-solid fa-file-pdf ml-1 btn" target="_blank" href="{{route('staff_analisakimiapdf', $ruangan->id)}}"></a> --}}
                                                <a href="{{route('ST_mikrobiologi_ruangan_pdf', $ruangan->id)}}" target="_blank"><i class="fa-solid fa-file-pdf ml-1 fa-lg"></i></a>
