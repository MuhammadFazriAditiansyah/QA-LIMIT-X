                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                @if($ruangan['statusOP'] == 0)
                                                    ...
                                                    {{-- {!! QrCode::size(100)->generate($ruangan->user_id_OP ."_". $ruangan->name_id_OP) !!} --}}
                                            ...
                                            <td>
                                                <form action="{{route('delete', $ruangan['id'])}}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    ...
                                                    {{-- <a class="fa-solid fa-file-pdf ml-1 btn" target="_blank" href="{{route('supervisor_analisakimiapdf', $ruangan->id)}}"></a> --}}
                                                    <a href="{{route('SP_mikrobiologi_ruangan_pdf', $ruangan->id)}}" target="_blank"><i class="fa-solid fa-file-pdf ml-1 fa-lg"></i></a>
