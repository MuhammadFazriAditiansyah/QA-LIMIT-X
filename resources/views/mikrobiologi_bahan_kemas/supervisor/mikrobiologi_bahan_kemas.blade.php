                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                @if($bahan_kemas['statusOP'] == 0)
                                                    ...
                                                    {{-- {!! QrCode::size(100)->generate($bahan_kemas->user_id_OP ."_". $bahan_kemas->name_id_OP) !!} --}}
                                            ...
                                            <td>
                                                <form action="{{route('delete', $bahan_kemas['id'])}}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    ...
                                                    {{-- <a class="fa-solid fa-file-pdf ml-1 btn" target="_blank" href="{{route('supervisor_analisakimiapdf', $bahan_kemas->id)}}"></a> --}}
                                                    <a href="{{route('SP_mikrobiologi_bahan_kemas_pdf', $bahan_kemas->id)}}" target="_blank"><i class="fa-solid fa-file-pdf ml-1 fa-lg"></i></a>
