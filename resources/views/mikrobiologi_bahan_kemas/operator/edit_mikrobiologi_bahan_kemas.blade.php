    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Edit Data Dokumen Mikrobiologi Bahan Kemas</h1>
            </div>
            ...
            <form action="{{route('update_mikrobiologi_bahan_kemas.post', $mikrobiologi_bahan_kemas['id'])}}" method="POST">
                @csrf
                @method('PATCH')
                                        ...
                                        <div class="card-body">
                                            <div class="form-row">
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" name="nodokumen" value="{{$mikrobiologi_bahan_kemas['nodokumen']}}" class="form-control" id="inputEmail4" placeholder="Masukkan No.Dokumen (4/LAK/V1/21)" disabled>
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="nama_produk">Nama Produk</label>
                                                    <input type="text" name="nama_produk" value="{{ $mikrobiologi_bahan_kemas['nama_produk'] }}" class="form-control" id="nama_produk" placeholder="Masukkan Nama Produk">
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="tgl_inokulasi">Tanggal Inokulasi (Tanggal Pemindahan)</label>
                                                    <input type="date" name="tgl_inokulasi" value="{{ $mikrobiologi_bahan_kemas['tgl_inokulasi'] }}" class="form-control" id="tgl_inokulasi" placeholder="Masukkan Tanggal Inokulasi (waktu pemindahan)">
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="tgl_pengamatan">Tanggal Pengamatan</label>
                                                    <input type="text" name="tgl_pengamatan" value="{{ $mikrobiologi_bahan_kemas['tgl_pengamatan'] }}" class="form-control" id="tgl_pengamatan" placeholder="Masukkan Tanggal Pengamatan">
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="satuan_tpc">Satuan TPC</label>
                                                    <input type="string" name="satuan_tpc" value="{{ $mikrobiologi_bahan_kemas['satuan_tpc'] }}" class="form-control" id="satuan_tpc" placeholder="Masukkan Satuan TPC">
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="satuan_yeast_mold">Satuan Yeast & Mold</label>
                                                    <input type="string" name="satuan_yeast_mold" value="{{ $mikrobiologi_bahan_kemas['satuan_yeast_mold'] }}" class="form-control" id="satuan_yeast_mold" placeholder="Masukkan Satuan Yeast & Mold">
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="satuan_coliform">Satuan Coliform</label>
                                                    <input type="string" name="satuan_coliform" value="{{ $mikrobiologi_bahan_kemas['satuan_coliform'] }}" class="form-control" id="satuan_coliform" placeholder="Masukkan Satuan Coliform">
                                                </div>
                                            </div>
                                        </div>
                                    {{-- </form> --}}
                ...
                <div class="section-body">
                    <h2 class="section-title">Edit Data Sampel Mikrobiologi Bahan Kemas</h2>
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="form-row" style="margin-top:-3%;">
                                                <div class="form-group col-md-3" align="center">
                                                    <label for="nama_bahan_kemas">Nama Bahan Kemas</label>
                                                </div>
                                                <div class="form-group col-md-2" align="center">
                                                    <label for="tpc">TPC ({{ $mikrobiologi_bahan_kemas->satuan_tpc }})</label>
                                                </div>
                                                <div class="form-group col-md-2" align="center">
                                                    <label for="yeast_mold">Yeast & Mold ({{ $mikrobiologi_bahan_kemas->satuan_yeast_mold }})</label>
                                                </div>
                                                <div class="form-group col-md-2" align="center">
                                                    <label for="cooliform">Coliform ({{ $mikrobiologi_bahan_kemas->satuan_coliform }})</label>
                                                </div>
                                                <div class="form-group col-md-3" align="center">
                                            ...
                                            <span class="d-none">{{ $i++ }} </span>
                                                ...
                                                <div class="form-row" style="margin-top:-2%;">
                                                    <div class="form-group col-md-3">
                                                        <input type="text" name="inputSampel[{{ $i }}][nama_bahan_kemas]" value="{{$bahan_kemas['nama_bahan_kemas']}}" class="form-control" id="nama_bahan_kemas" placeholder="Masukkan nama bahan kemas">
                                                    </div>
                                                    <div class="form-group col-md-2">
                                                        <input type="text" name="inputSampel[{{ $i }}][tpc]" value="{{$bahan_kemas['tpc']}}" class="form-control" id="tpc" placeholder="Masukkan nama sampel">
                                                    </div>
                                                    <div class="form-group col-md-2">
                                                        <input type="text" name="inputSampel[{{ $i }}][yeast_mold]" value="{{$bahan_kemas['yeast_mold']}}" class="form-control" id="yeast_mold" placeholder="Masukkan nama sampel">
                                                    </div>
                                                    <div class="form-group col-md-2">
                                                        <input type="text" name="inputSampel[{{ $i }}][coliform]" value="{{$bahan_kemas['coliform']}}" class="form-control" id="coliform" placeholder="Masukkan nama sampel">
                                                    </div>
                                                    <div class="form-group col-md-3">
                                                        <input type="text" name="inputSampel[{{ $i }}][keterangan]" value="{{$bahan_kemas['keterangan']}}" class="form-control" id="keterangan" placeholder="Masukkan nama sampel">
                                                    </div>
                                                </div>
                                            @endforeach
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href="/operator/mikrobiologi_bahan_kemas" class="btn btn-primary" style="width:30%; text-align:center; margin-top:-60px;">Back</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="main-content" style="margin-top:-6%;">
            <section class="section">
                <form action="{{route('sampel_mikrobiologi_bahan_kemas.post', $mikrobiologi_bahan_kemas['id'])}}" method="POST">
                    @csrf
                                            ...
                                            {{-- <form action="{{route('sampel_analisa_kimia.post', $futamis['id'])}}" method="POST">
                                                ...
                                                <div class="card-body" id="sampel">
                                                    <div class="form-row" style="margin-top:-1%;">
                                                        ...
                                                        <div class="form-group col-md-2" align="center">
                                                            <label for="coliform">Coliform ({{ $mikrobiologi_bahan_kemas->satuan_coliform }})</label>
                                                        </div>
                                                        <div class="form-group col-md-2" align="center">
                                                            <label for="keterangan">Keterangan</label>
                                                        </div>
                                                    ...
                                                    <div class="form-row" style="margin-top:-3%;">
                                                        <div class="form-group col-md-3">
                                                            <input type="text" name="inputSampel[0][nama_bahan_kemas]" class="form-control" id="nama_bahan_kemas" placeholder="Masukkan Nama Bahan kemas">
                                                        </div>
                                                        <div class="form-group col-md-2">
    ...
    $('#addSampel').click(function(){
        if(i < maxInput){
            ...
            <div class="card-body removeSampel" id="removeSampel" style="margin-top: -5%; margin-left:-25px;">
                ...
                <div class="form-row" style="margin-top:1%;">
                    <div class="form-group col-md-3">
                        <input type="text" name="inputSampel[${i}][nama_bahan_kemas]" class="form-control" id="nama_bahan_kemas" placeholder="Masukkan Nama Bahan Kemas">
                    </div>
                    <div class="form-group col-md-2">
