    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Tambah Data Sampel Mikrobiologi Bahan Kemas</h1>
            </div>
            ...
            <div class="section-body">
                <h2 class="section-title">Tambah Data Sampel Mikrobiologi Bahan Kemas</h2>
                <div class="row shadow">
                    <div class="col-12">
                        <div class="card">
                            <div class="card">
                                <form action="{{route('sampel_mikrobiologi_bahan_kemas', $id)}}" method="POST">
                                  @csrf
    ...
    $('#addSampel').click(function(){
        if(i < maxInput){
            ...
            <div class="card-body removeSampel" id="removeSampel" style="margin-top: -5%; margin-left:-25px;">
                ...
                <div class="form-row" style="margin-top:1%;">
                    <div class="form-group col-md-3">
                        <input type="text" name="inputSampel[${i}][nama_bahan_kemas]" class="form-control" id="nama_bahan_kemas" placeholder="Masukkan Kode sampling">
                    </div>
                    <div class="form-group col-md-2">
