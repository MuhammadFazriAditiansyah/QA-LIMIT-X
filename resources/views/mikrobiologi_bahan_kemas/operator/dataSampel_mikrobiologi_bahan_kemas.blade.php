            ...
            <div class="main-content">
                <section class="section">
                    ...
                    <div class="section-body">
                        <h2 class="section-title">Data Sampel Analisa Mikrobiologi Bahan Kemas</h2>
                        <div class="row">
                            <div class="col-12">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-md">
                                                <tr>
                                                    ...
                                                    <th scope="col">TPC ({{ $mikrobiologi_bahan_kemas->satuan_tpc }})</th>
                                                    <th scope="col">Yeast & Mold ({{ $mikrobiologi_bahan_kemas->satuan_yeast_mold }})</th>
                                                    <th scope="col">Coliform ({{ $mikrobiologi_bahan_kemas->satuan_coliform }})</th>
                                                    <th scope="col">Keterangan</th>
                                                    <th scope="col">Action</th>
                                                </tr>
                                                <tr>
                                                    @forelse ($sampel_mikrobiologi_bahan_kemas as $bahan_kemas)
                                                        <tr id="{{ $bahan_kemas->id }}">
                                                            ...
                                                            <td>
                                                                <form action="{{route('sampel_mikrobiologi_bahan_kemas_Delete', $bahan_kemas['id'])}}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
