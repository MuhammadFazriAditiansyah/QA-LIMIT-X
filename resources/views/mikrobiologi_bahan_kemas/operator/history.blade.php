...
@section('content')
  ...
  <div id="app">
      <div class="main-wrapper main-wrapper-1">
          ...
          <nav class="navbar navbar-expand-lg main-navbar">
            {{-- <form action="{{route('delete', $futami['id'])}}" method="POST"> --}}
                ...
                <form class="form-inline mr-auto" method="GET" action="{{ route('mikrobiologi_bahan_kemas_history') }}">
                ...
                <a class="text-success btn" href="/operator/mikrobiologi_bahan_kemas/history" style="margin-right:24%;"><i class="fa-solid fa-arrows-rotate fa-lg"></i></a>
          ...
          <div class="main-content">
              <section class="section">
                  <div class="section-header">
                      <h1>History Analisa Mikrobiologi Bahan Kemas</h1>
                  </div>

                  <div class="section-body">
                      <h2 class="section-title">History Analisa Mikrobiologi Bahan Kemas</h2>
                          ...
                          <div class="col-12">
                              <div class="card shadow">
                                ...
                                <div class="button" style="margin-left:4%; margin-top:3%;">
                                    <a href="/operator/mikrobiologi_bahan_kemas" class="btn btn-icon icon-left btn-primary"><i class="fa-solid fa-house"></i> Back</a>
                                                  ...
                                                  <tr>
                                                      ...
                                                      <td>
                                                        <div class="d-flex justify-content-start align-items-center">
                                                            ...
                                                            <form action="{{ route('mikrobiologi_bahan_kemas.restore', $bahan_kemas->id) }}" method="POST" class="mr-2">
                                                                @csrf
                                                            ...
                                                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#confirmDeleteModal-{{ $bahan_kemas->id }}">
                                                      ...
                                                      {{-- <td align="center">
                                                        @if($bahan_kemas['statusOP'] == 0)
                                                          <form action="/operator/bahan_kemas/ttd/{{$bahan_kemas['id']}}" method="POST" class="text-center">
                                                            @csrf
                                                            @method('PATCH')
                                                        ...
                                                        @elseif($bahan_kemas['statusOP'] == 1)
                                                          <img src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(100)->generate($bahan_kemas->user_id_OP .'_'. $bahan_kemas->name_id_OP)) !!}" alt="">

                                                        @endif

                                                      </td> --}}
                                                      {{-- <td>
                                                          <form action="{{route('mikrobiologi_Delete', $bahan_kemas['id'])}}" method="POST">
                                                              @csrf
                                                              @method('PATCH')
                                                              ...
                                                              <br>
                                                              <a class="fa-solid fa-pen-to-square text-success btn" href="{{route('edit_mikrobiologi', $bahan_kemas->id)}}"></a>

                                                              <br>
                                                              <a class="fa-solid fa-file-pdf ml-1 btn" target="_blank" href="{{route('operator_mikrobiologi_pdf', $bahan_kemas->id)}}"></a>
                                                              <br>
                                                              <a href="{{ route('mikrobiologi_sampel', $bahan_kemas->id) }}" class="btn btn-icon icon-left btn-primary"><i class="fa-solid fa-table"></i> Data sampel</a>
                                                          </form>
                                                      </td> --}}
                                                  </tr>
    ...
    <!-- Modal Konfirmasi -->
@foreach ($mikrobiologi_bahan_kemas as $mikrobiologi)
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="{{ route('mikrobiologi_bahan_kemas_delete_permanent', $mikrobiologi->id) }}" method="POST">
                    @csrf
                    @method('DELETE')
