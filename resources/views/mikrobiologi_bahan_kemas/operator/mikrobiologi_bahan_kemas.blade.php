                                    ...
                                    <table class="table table-bordered table-md">
                                        ...
                                        @forelse ($mikrobiologi_bahan_kemas as $bahan_kemas)
                                            <tr>
                                                ...
                                                <td>{{ Carbon\Carbon::parse($bahan_kemas->tgl_inokulasi)->translatedFormat('d F Y') }}
                                                </td>
                                                {{-- <td>{{Carbon\Carbon::parse($bahan_kemas->tgl_pengamatan)->translatedFormat('d F Y')}}</td> --}}
                                                <td align="center">
                                                    @if ($bahan_kemas['statusOP'] == 0)
                                                        <form
                                                            action="/operator/mikrobiologi_bahan_kemas/ttd/{{ $bahan_kemas['id'] }}"
                                                    ...
                                                    @elseif($bahan_kemas['statusOP'] == 1)
                                                        <img src="data:image/png;base64, {!! base64_encode(
                                                            QrCode::format('png')->size(80)->generate($bahan_kemas->user_id_OP . '_' . $bahan_kemas->name_id_OP),
                                                        ) !!}"
                                                            alt="">
                                                    @endif
                                                </td>
                                                <td>
                                                    ...
                                                    @elseif($bahan_kemas['statusST'] == 1)
                                                        ...
                                                        <img src="data:image/png;base64, {!! base64_encode(
                                                            QrCode::format('png')->size(80)->generate($bahan_kemas->user_id_ST . '_' . $bahan_kemas->name_id_ST),
                                                        ) !!}"
                                                            alt="">
                                                ...
                                                <td>
                                                    ...
                                                    @elseif($bahan_kemas['statusSP'] == 1)
                                                        ...
                                                        <img src="data:image/png;base64, {!! base64_encode(
                                                            QrCode::format('png')->size(80)->generate($bahan_kemas->user_id_SP . '_' . $bahan_kemas->name_id_SP),
                                                        ) !!}"
                                                            alt="">
                                                    @endif
                                                </td>
                                                <td align="center" style="justify-content:center;">
                                                    <form
                                                        action="{{ route('mikrobiologi_bahan_kemas_Delete', $bahan_kemas['id']) }}"
                                                        method="POST">
                                                        @csrf
                                                        {{-- @method('DELETE')  --}}
                                                        @method('PATCH')
                                                        ...
                                                        <a class="fa-solid fa-pen-to-square text-success btn"
                                                            href="{{ route('edit_mikrobiologi_bahan_kemas', $bahan_kemas->id) }}"></a>

                                                        <br>
                                                        <a class="fa-solid fa-file-pdf ml-1 btn" target="_blank"
                                                            href="{{ route('OP_mikrobiologi_bahan_kemas_pdf', $bahan_kemas->id) }}"></a>

                                                        <a target="_blank"
                                                            href="{{ route('mikrobiologi_bahan_kemas_excel_show', $bahan_kemas->id) }}">
                                                        ...
                                                        <br>
                                                        <a href="{{ route('mikrobiologi_bahan_kemas_sampel', $bahan_kemas->id) }}"
