                ...
                <div class="col-12">
                    <div class="card p-4">
                        <div class="card-header">
                            ...
                            <a href="/superadmin/mikrobiologi_bahan_kemas/history" class="btn btn-primary btn-sm" style="width:auto; text-align:center; float:right;"><i class="fa fa-history"></i> History</a>
                                ...
                                <tbody>
                                    @forelse ($mikrobiologi_bahan_kemas as $bahan_kemas)
                                        <tr>
                                            ...
                                            {{-- <td>{{ $bahan_kemas->tgl_pengamatan }}</td> --}}
                                            <td>{{Carbon\Carbon::parse($bahan_kemas->tanggal_uji)->translatedFormat('d F Y')}}</td>
                                            <td align="center">
                                            ...
                                            <td align="center">
                                                ...
                                                @elseif($bahan_kemas['statusST'] == 1)
                                                    {{-- {!! QrCode::size(50)->generate($bahan_kemas->nodokumen) !!} --}}
                                            ...
                                            <td align="center">
                                                ...
                                                {{-- <form action="/supervisorttd/{{$bahan_kemas['id']}}" method="POST">
                                                    @csrf
                                                    @method('PATCH')
                                                    <button type="submit" class="badge badge-success btn">TTD</button>
                                            ...
                                            <td align="center" style="justify-content:center;">
                                                <a class="fa-solid fa-file-pdf ml-1 btn" target="_blank" href="{{route('SA_mikrobiologi_bahan_kemas_pdf', $bahan_kemas->id)}}"></a>
                                                <a class="fa-solid fa-file-excel ml-1 btn" target="_blank" href="{{route('mikrobiologi_bahan_kemas_excel_show', $bahan_kemas->id)}}"></a>

                                                <a href="{{ route('superadmin_mikrobiologi_bahan_kemas_sampel', $bahan_kemas->id) }}" class="btn btn-icon icon-left btn-primary"><i class="fa-solid fa-table"></i> Data</a>
                                            </td>
                                        </tr>
                                            @empty
                                            <tr>
