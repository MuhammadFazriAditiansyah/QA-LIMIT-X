...
@section('content')
    ...
    <div class="content-wrapper" style="margin-top: -43%; ">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1>Data Sampel Analisa Mikrobiologi Bahan Kemas</h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        </section>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="/superadmin/mikrobiologi_bahan_kemas/info" class="btn btn-danger btn-sm" style="width:auto; text-align:center;"><i class="fa fa-house"></i> Back</a>
                        ...
                        <table id="example1" class="table table-bordered table-striped" style="margin-bottom:2%;">
                            <thead>
                                <tr>
                                    ...
                                    <th>TPC ({{ $mikrobiologi_bahan_kemas->satuan_tpc }})</th>
                                    <th>Yeast & Mold ({{ $mikrobiologi_bahan_kemas->satuan_yeast_mold }})</th>
                                    <th>Coliform ({{ $mikrobiologi_bahan_kemas->satuan_coliform }})</th>
                                    <th>Keterangan (Optional)</th>
                                    {{-- <th align="center">Action</th> --}}
                                </tr>
                            </thead>
                            <tbody>
                                @forelse ($sampel_mikrobiologi_bahan_kemas as $bahan_kemas)
                                    <tr>
                                        <td>{{++$no}}</td>
                                        ...
                                        {{-- <td>
                                            <a class="fa-solid fa-file-pdf ml-1 btn" target="_blank" href="{{route('superadmin_analisakimiapdf', $bahan_kemas->id)}}"></a>
                                            <a href="{{ route('mikrobiologi_sampel', $bahan_kemas->id) }}" class="btn btn-icon icon-left btn-primary"><i class="fa-solid fa-table"></i> Data</a>
                                        </td> --}}
                                    </tr>
                                        @empty
                                        <tr>
