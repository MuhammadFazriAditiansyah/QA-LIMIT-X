                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="/superadmin/mikrobiologi_bahan_kemas/info" class="btn btn-danger" style="width:auto; text-align:center; ">Back</a>
                                ...
                                <tbody>
                                    @forelse ($mikrobiologi_bahan_kemas as $bahan_kemas)
                                        <tr>
                                            ...
                                            {{-- <td>{{Carbon\Carbon::parse($bahan_kemas->tgl_pengamatan)->translatedFormat('d F Y')}}</td>                                            <td>{{Carbon\Carbon::parse($bahan_kemas->tanggal_uji)->translatedFormat('d F Y')}}</td> --}}
                                            <td align="center">
                                            ...
                                            {{-- <td>
                                                <a class="fa-solid fa-file-pdf ml-1 btn" target="_blank" href="{{route('superadmin_mikrobiologi_pdf', $bahan_kemas->id)}}"></a>

                                                <a href="{{ route('superadmin_mikrobiologi_sampel', $bahan_kemas->id) }}" class="btn btn-icon icon-left btn-primary"><i class="fa-solid fa-table"></i> Data</a>
                                            </td> --}}
                                        </tr>
                                            @empty
                                            <tr>
