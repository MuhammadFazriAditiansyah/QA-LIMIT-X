                        ...
                        <div class="col-12">
                            <div class="card shadow">
                                ...
                                <div class="button" style="margin-left:4%;">
                                    ...
                                    <a href="/operator/add_mikrobiologi_personil" class="btn btn-success" style="margin-top: 20px;"><i class="fa fa-plus"></i> Tambah Data</a>

                                    <a href="/operator/mikrobiologi_personil/history" class="btn btn-danger" style="width:auto; text-align:center; float:right; margin:20px;"><i class="fa fa-history"></i> History Delete</a>
                                  </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        @if($personil['statusOP'] == 0)
                                                            <form action="/operator/mikrobiologi_personil/ttd/{{$personil['id']}}" method="POST" class="text-center">
                                                                @csrf
                                                                @method('PATCH')
                                                    ...
                                                    <td align="center" style="justify-content:center;">
                                                        <form action="{{route('mikrobiologi_personil_Delete', $personil['id'])}}" method="POST">
                                                            @csrf
                                                            {{-- @method('DELETE')  --}}
                                                            @method('PATCH')
                                                            ...
                                                            <br>
                                                            <a class="fa-solid fa-pen-to-square text-success btn" href="{{route('edit_mikrobiologi_personil', $personil->id)}}"></a>

                                                            <br>
                                                            <a class="fa-solid fa-file-pdf ml-1 btn" target="_blank" href="{{route('OP_mikrobiologi_personil_pdf', $personil->id)}}"></a>

                                                            <a target="_blank" href="{{route('mikrobiologi_personil_excel_show', $personil->id)}}">
                                                            ...
                                                            <br>
                                                            <a href="{{ route('mikrobiologi_personil_sampel', $personil->id) }}" class="btn btn-icon icon-left btn-primary"><i class="fa-solid fa-table"></i> Data sampel</a>
