    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Edit Data Dokumen Mikrobiologi Personil</h1>
            </div>
            ...
            <form action="{{route('update_mikrobiologi_personil.post', $mikrobiologi_personil['id'])}}" method="POST">
                @csrf
                @method('PATCH')
                                        ...
                                        <div class="card-body">
                                            <div class="form-row">
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" name="nodokumen" value="{{$mikrobiologi_personil['nodokumen']}}" class="form-control" id="inputEmail4" placeholder="Masukkan No.Dokumen (4/LAK/V1/21)" disabled>
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="nama_produk">Nama Produk</label>
                                                    <input type="string" name="nama_produk" value="{{$mikrobiologi_personil['nama_produk'] }}" class="form-control" id="nama_produk" placeholder="Masukkan Nama Produk">
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="tgl_inokulasi">Tanggal Inokulasi (Tanggal Pemindahan)</label>
                                                    <input type="date" name="tgl_inokulasi" value="{{ $mikrobiologi_personil['tgl_inokulasi'] }}" class="form-control" id="tgl_inokulasi" placeholder="Masukkan Tanggal Inokulasi (waktu pemindahan)">
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="tgl_pengamatan">Tanggal Pengamatan</label>
                                                    <input type="text" name="tgl_pengamatan" value="{{ $mikrobiologi_personil['tgl_pengamatan'] }}" class="form-control" id="tgl_pengamatan" placeholder="Masukkan Tanggal Pengamatan">
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="satuan_tpc">Satuan TPC</label>
                                                    <input type="string" name="satuan_tpc" value="{{ $mikrobiologi_personil->satuan_tpc }}" class="form-control" id="satuan_tpc" placeholder="Masukkan Satuan TPC">
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="satuan_yeast_mold">Satuan Yeast & Mold</label>
                                                    <input type="string" name="satuan_yeast_mold" value="{{ $mikrobiologi_personil->satuan_yeast_mold }}" class="form-control" id="satuan_yeast_mold" placeholder="Masukkan Satuan Yeast & Mold">
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="satuan_coliform">Satuan Coliform</label>
                                                    <input type="string" name="satuan_coliform" value="{{ $mikrobiologi_personil->satuan_coliform }}" class="form-control" id="satuan_coliform" placeholder="Masukkan Satuan Coliform">
                                                </div>
                                            </div>
                                        </div>
                                    {{-- </form> --}}
                ...
                <div class="section-body">
                    <h2 class="section-title">Edit Data Mikrobiologi Personil</h2>
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="form-row" style="margin-top:-3%;">
                                                ...
                                                <div class="form-group col-md-2" align="center">
                                                    ...
                                                    <label for="tpc">TPC({{ $mikrobiologi_personil->satuan_tpc }})</label>
                                                </div>
                                                <div class="form-group col-md-2" align="center">
                                                    {{-- <label for="yeast_mold">Yeast & Mold(cfu/25cm<sup>2</sup>)</label> --}}
                                                    <label for="yeast_mold">Yeast & Mold({{ $mikrobiologi_personil->satuan_yeast_mold }})</label>
                                                </div>
                                                <div class="form-group col-md-2" align="center">
                                                    <label for="coliform">Coliform ({{ $mikrobiologi_personil->satuan_coliform }})</label>
                                                </div>
                                                 <div class="form-group col-md-2" align="center">
                                            ...
                                            <span class="d-none">{{ $i++ }} </span>
                                                ...
                                                <div class="form-row" style="margin-top:-2%;">
                                                    <div class="form-group col-md-2">
                                                        <input type="text" name="inputSampel[{{ $i }}][nama_objek]" value="{{$personil['nama_objek']}}" class="form-control" id="area" placeholder="Masukkan nama Objek">
                                                    </div>
                                                    <div class="form-group col-md-2">
                                                        <input type="time" name="inputSampel[{{ $i }}][jam_sampling]" value="{{$personil['jam_sampling']}}" class="form-control" id="jam_sampling" placeholder="Masukkan Jam Sampling">
                                                    </div>
                                                    <div class="form-group col-md-2">
                                                        <input type="text" name="inputSampel[{{ $i }}][tpc]" value="{{$personil['tpc']}}" class="form-control" id="tpc" placeholder="Masukkan nama TPC">
                                                    </div>
                                                    <div class="form-group col-md-2">
                                                        <input type="text" name="inputSampel[{{ $i }}][yeast_mold]" value="{{$personil['yeast_mold']}}" class="form-control" id="yeast_mold" placeholder="Masukkan Yeast & Mold">
                                                    </div>
                                                    <div class="form-group col-md-2">
                                                        <input type="text" name="inputSampel[{{ $i }}][coliform]" value="{{$personil['coliform']}}" class="form-control" id="coliform" placeholder="Masukkan Coliform">
                                                    </div>
                                                    <div class="form-group col-md-2">
                                                        <input type="text" name="inputSampel[{{ $i }}][keterangan]" value="{{$personil['keterangan']}}" class="form-control" id="keterangan" placeholder="Masukkan Keterangan">
                                                    </div>
                                                </div>
                                            @endforeach
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href="/operator/mikrobiologi_personil" class="btn btn-primary" style="width:30%; text-align:center; margin-top:-60px;">Back</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="main-content" style="margin-top:-6%;">
            <section class="section">
                <form action="{{route('sampel_mikrobiologi_personil.post', $mikrobiologi_personil['id'])}}" method="POST">
                    @csrf

                    <div class="section-body">
                        <h2 class="section-title">Tambah Data Personil</h2>
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
