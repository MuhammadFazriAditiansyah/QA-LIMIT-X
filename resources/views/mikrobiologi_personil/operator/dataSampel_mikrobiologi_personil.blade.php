                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-md">
                                                <tr>
                                                    ...
                                                    <th scope="col">TPC ({{ $mikrobiologi_personil->satuan_tpc }})</th>
                                                    <th scope="col">Yeast & Mold ({{ $mikrobiologi_personil->satuan_yeast_mold }})</th>
                                                    {{-- <th scope="col">TPC (cfu/25cm<sup>2</sup>)</th> --}}
                                                    {{-- <th scope="col">Yeast & Mold (cfu/25cm<sup>2</sup>)</th> --}}
                                                    <th scope="col">coliform ({{ $mikrobiologi_personil->satuan_coliform }})</th>
                                                ...
                                                <tr>
                                                    @forelse ($sampel_mikrobiologi_personil as $personil)
                                                        <tr id="{{ $personil->id }}">
                                                            ...
                                                            <td>
                                                                <form action="{{route('sampel_mikrobiologi_personil_Delete', $personil['id'])}}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
