    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Tambah Data Mikrobiologi Personil</h1>
            </div>
            ...
            <div class="section-body">
                <h2 class="section-title">Tambah Data Mikrobiologi Personil</h2>
                <div class="row shadow">
                    <div class="col-12">
                        <div class="card">
                            <div class="card">
                                <form action="{{route('sampel_mikrobiologi_personil', $id)}}" method="POST">
                                  @csrf
