                ...
                <div class="col-12">
                    <div class="card p-4">
                        <div class="card-header">
                            ...
                            <a href="/superadmin/mikrobiologi_personil/history" class="btn btn-primary btn-sm" style="width:auto; text-align:center; float:right;"><i class="fa fa-history"></i> History</a>
                                    ...
                                    @forelse ($mikrobiologi_personil as $personil)
                                        <tr>
                                            ...
                                            <td align="center" style="justify-content:center; padding-left:10px;">
                                                <a class="fa-solid fa-file-pdf ml-1 btn" target="_blank" href="{{route('SA_mikrobiologi_personil_pdf', $personil->id)}}"></a>
                                                <a class="fa-solid fa-file-excel ml-1 btn" target="_blank" href="{{route('mikrobiologi_personil_excel_show', $personil->id)}}"></a>

                                                <a href="{{ route('superadmin_mikrobiologi_personil_sampel', $personil->id) }}" class="btn btn-icon icon-left btn-primary"><i class="fa-solid fa-table"></i> Data</a>
                                            </td>
                                        </tr>
                                            @empty
                                            <tr>
