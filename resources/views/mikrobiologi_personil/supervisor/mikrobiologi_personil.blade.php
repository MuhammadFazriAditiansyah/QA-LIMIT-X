                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                @if($personil['statusOP'] == 0)
                                                    ...
                                                    {{-- {!! QrCode::size(100)->generate($personil->user_id_OP ."_". $personil->name_id_OP) !!} --}}
                                            ...
                                            <td>
                                                <form action="{{route('delete', $personil['id'])}}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    ...
                                                    {{-- <a class="fa-solid fa-file-pdf ml-1 btn" target="_blank" href="{{route('supervisor_analisakimiapdf', $personil->id)}}"></a> --}}
                                                    <a href="{{route('SP_mikrobiologi_personil_pdf', $personil->id)}}" target="_blank"><i class="fa-solid fa-file-pdf ml-1 fa-lg"></i></a>
