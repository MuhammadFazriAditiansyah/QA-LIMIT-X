            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="/superadmin/mikrobiologi_bahan_baku/info" class="btn btn-danger btn-sm" style="width:auto; text-align:center;"><i class="fa fa-house"></i> Back</a>
                        ...
                        <table id="example1" class="table table-bordered table-striped" style="margin-bottom:2%;">
                            <thead>
                                <tr>
                                    ...
                                    <th>TPC ({{ $mikrobiologi_bahan_baku->satuan_tpc }})</th>
                                    <th>Yeast & Mold ({{ $mikrobiologi_bahan_baku->satuan_yeast_mold }})</th>
                                    <th>Coliform ({{ $mikrobiologi_bahan_baku->satuan_coliform }})</th>
                            ...
                            <tbody>
                                @forelse ($sampel_mikrobiologi_bahan_baku as $bahan_baku)
                                    <tr>
                                        ...
                                        {{-- <td>
                                            <a class="fa-solid fa-file-pdf ml-1 btn" target="_blank" href="{{route('superadmin_analisakimiapdf', $bahan_baku->id)}}"></a>
                                            <a href="{{ route('mikrobiologi_sampel', $bahan_baku->id) }}" class="btn btn-icon icon-left btn-primary"><i class="fa-solid fa-table"></i> Data</a>
                                        </td> --}}
                                    </tr>
                                        @empty
                                        <tr>
