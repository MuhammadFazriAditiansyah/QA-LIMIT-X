                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                @if($bahan_baku['statusOP'] == 0)
                                                    ...
                                                    {{-- {!! QrCode::size(100)->generate($bahan_baku->user_id_OP ."_". $bahan_baku->name_id_OP) !!} --}}
                                            ...
                                            <td>
                                                <form action="{{route('delete', $bahan_baku['id'])}}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    ...
                                                    {{-- <a class="fa-solid fa-file-pdf ml-1 btn" target="_blank" href="{{route('supervisor_analisakimiapdf', $bahan_baku->id)}}"></a> --}}
                                                    <a href="{{route('SP_mikrobiologi_bahan_baku_pdf', $bahan_baku->id)}}" target="_blank"><i class="fa-solid fa-file-pdf ml-1 fa-lg"></i></a>
