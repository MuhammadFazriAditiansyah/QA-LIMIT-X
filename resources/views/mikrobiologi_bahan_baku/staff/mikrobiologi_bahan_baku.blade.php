   ...
   <div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">Data Analisa Mikrobiologi Bahan Baku</h2>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            @if($bahan_baku['statusOP'] == 0)
                                                ...
                                                {{-- {!! QrCode::size(80)->generate($bahan_baku->user_id_OP ."_". $bahan_baku->name_id_OP) !!} --}}
                                            @endif
                                        </td>
                                        <td align="center">
                                            @if($bahan_baku['statusST'] == 0)
                                                <form action="/staff/mikrobiologi_bahan_baku/ttd/{{$bahan_baku['id']}}" method="POST" class="text-center">
                                                    @csrf
                                                    @method('PATCH')
                                                ...
                                                <form action="/staff/mikrobiologi_bahan_baku/declinettd/{{$bahan_baku['id']}}" method="POST" style="margin-top:5%;" class="text-center">
                                                    @csrf
                                                    @method('PATCH')
                                        ...
                                        <td align="center" style="justify-content;center;">
                                            <form action="{{route('delete', $bahan_baku['id'])}}" method="POST" style="text-center">
                                                @csrf
                                                @method('DELETE')
                                                {{-- <button class="text-danger btn"><i class="fa-solid fa-trash"></i></button>
                                                <br>
                                                <a class="fa-solid fa-pen-to-square text-success btn" href="{{route('edit', $bahan_baku->id)}}"></a>
                                                <br>--}}

                                                {{-- <a class="fa-solid fa-file-pdf ml-1 btn" target="_blank" href="{{route('staff_analisakimiapdf', $bahan_baku->id)}}"></a> --}}
                                                <a href="{{route('ST_mikrobiologi_bahan_baku_pdf', $bahan_baku->id)}}" target="_blank"><i class="fa-solid fa-file-pdf ml-1 fa-lg"></i></a>
