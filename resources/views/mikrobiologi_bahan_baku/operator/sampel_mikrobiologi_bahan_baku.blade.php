    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Tambah Data Sampel Mikrobiologi Bahan Baku</h1>
            </div>
            ...
            <div class="section-body">
                <h2 class="section-title">Tambah Data Sampel Mikrobiologi Bahan Baku</h2>
                <div class="row shadow">
                    <div class="col-12">
                        <div class="card">
                            <div class="card">
                                <form action="{{route('sampel_mikrobiologi_bahan_baku.post', $id)}}" method="POST">
                                  @csrf
                                    ...
                                    <div class="form-row" style="margin-top:1%;">
                                        ...
                                        <div class="form-group col-md-2" align="center">
                                            <label for="tpc">TPC ({{ $mikrobiologiBahanBaku->satuan_tpc }})</label>
                                        </div>
                                        <div class="form-group col-md-2" align="center">
                                            <label for="yeast_mold">Yeast & Mold ({{ $mikrobiologiBahanBaku->satuan_yeast_mold }})</label>
                                        </div>
                                        <div class="form-group col-md-2" align="center">
                                            <label for="coliform">Coliform ({{ $mikrobiologiBahanBaku->satuan_coliform }})</label>
                                        </div>
                                        <div class="form-group col-md-2" align="center">
    ...
    $('#addSampel').click(function(){
        if(i < maxInput){
            ...
            <div class="card-body removeSampel" id="removeSampel" style="margin-top: -5%; margin-left:-25px;">
                ...
                <div class="form-row" style="margin-top:1%;">
                    <div class="form-group col-md-3">
                        <input type="text" name="inputSampel[${i}][nama_bahan_baku]" class="form-control" id="nama_bahan_baku" placeholder="Masukkan Kode sampling">
                    </div>
                    <div class="form-group col-md-2">
