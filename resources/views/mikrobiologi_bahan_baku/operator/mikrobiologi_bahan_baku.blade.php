                        ...
                        <div class="col-12">
                            <div class="card shadow">
                                ...
                                <div class="button" style="margin-left:4%;">
                                    ...
                                    <a href="/operator/add_mikrobiologi_bahan_baku" class="btn btn-success" style="margin-top: 20px;"><i class="fa fa-plus"></i> Tambah Data</a>

                                    <a href="/operator/mikrobiologi_bahan_baku/history" class="btn btn-danger" style="width:auto; text-align:center; float:right; margin:20px;"><i class="fa fa-history"></i> History Delete</a>
                                  </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        @if($bahan_baku['statusOP'] == 0)
                                                            <form action="/operator/mikrobiologi_bahan_baku/ttd/{{$bahan_baku['id']}}" method="POST" class="text-center">
                                                                @csrf
                                                                @method('PATCH')
                                                    ...
                                                    <td align="center" style="justify-content:center;">
                                                        <form action="{{route('mikrobiologi_bahan_baku_Delete', $bahan_baku['id'])}}" method="POST">
                                                            @csrf
                                                            {{-- @method('DELETE')  --}}
                                                            @method('PATCH')
                                                            ...
                                                            <br>
                                                            <a class="fa-solid fa-pen-to-square text-success btn" href="{{route('edit_mikrobiologi_bahan_baku', $bahan_baku->id)}}"></a>

                                                            <br>
                                                            <a class="fa-solid fa-file-pdf ml-1 btn" target="_blank" href="{{route('OP_mikrobiologi_bahan_baku_pdf', $bahan_baku->id)}}"></a>

                                                            <a target="_blank" href="{{route('mikrobiologi_bahan_baku_excel_show', $bahan_baku->id)}}">
                                                            ...
                                                            <br>
                                                            <a href="{{ route('mikrobiologi_bahan_baku_sampel', $bahan_baku->id) }}" class="btn btn-icon icon-left btn-primary"><i class="fa-solid fa-table"></i> Data sampel</a>
