...
@section('content')
      ...
      <div class="main-wrapper main-wrapper-1">
          ...
          <nav class="navbar navbar-expand-lg main-navbar">
            {{-- <form action="{{route('delete', $futami['id'])}}" method="POST"> --}}
                ...
                <form class="form-inline mr-auto" method="GET" action="{{ route('mikrobiologi_bahan_baku_history') }}">
                ...
                <a class="text-success btn" href="/operator/mikrobiologi_bahan_baku/history" style="margin-right:24%;"><i class="fa-solid fa-arrows-rotate fa-lg"></i></a>
          ...
          <div class="main-content">
              <section class="section">
                  ...
                  <div class="section-body">
                      <h2 class="section-title">History Analisa Mikrobiologi Bahan Baku</h2>
                                ...
                                <div class="card-body mt-3 shadow">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-md">
                                            ...
                                            @forelse ($mikrobiologi_bahan_baku as $produk_percobaan)
                                                  <tr>
                                                      ...
                                                      <td>
                                                        <div class="d-flex justify-content-start align-items-center">
                                                            ...
                                                            <form action="{{ route('mikrobiologi_bahan_baku.restore', $produk_percobaan->id) }}" method="POST" class="mr-2">
                                                                @csrf
                                                      ...
                                                      {{-- <td align="center">
                                                        @if($produk_percobaan['statusOP'] == 0)
                                                          <form action="/operator/produk_percobaan/ttd/{{$produk_percobaan['id']}}" method="POST" class="text-center">
                                                            @csrf
                                                            @method('PATCH')
                                                        ...
                                                        @elseif($produk_percobaan['statusOP'] == 1)
                                                          <img src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(100)->generate($produk_percobaan->user_id_OP .'_'. $produk_percobaan->name_id_OP)) !!}" alt="">

                                                        @endif

                                                      </td> --}}
                                                      {{-- <td>
                                                          <form action="{{route('mikrobiologi_Delete', $produk_percobaan['id'])}}" method="POST">
                                                              @csrf
                                                              @method('PATCH')
                                                              ...
                                                              <br>
                                                              <a class="fa-solid fa-pen-to-square text-success btn" href="{{route('edit_mikrobiologi', $produk_percobaan->id)}}"></a>

                                                              <br>
                                                              <a class="fa-solid fa-file-pdf ml-1 btn" target="_blank" href="{{route('operator_mikrobiologi_pdf', $produk_percobaan->id)}}"></a>
                                                              <br>
                                                              <a href="{{ route('mikrobiologi_sampel', $produk_percobaan->id) }}" class="btn btn-icon icon-left btn-primary"><i class="fa-solid fa-table"></i> Data sampel</a>
                                                          </form>
                                                      </td> --}}
                                                  </tr>
  ...
  <!-- Modal Konfirmasi -->
@foreach ($mikrobiologi_bahan_baku as $mikrobiologi)
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="{{ route('mikrobiologi_bahan_baku_delete_permanent', $mikrobiologi->id) }}" method="POST">
                    @csrf
                    @method('DELETE')
