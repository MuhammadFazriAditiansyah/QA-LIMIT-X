...
class MikrobiologiBahanKemasExport implements FromView, ShouldAutoSize, WithStyles, WithDrawings, WithEvents
{
    /**
    ...
    */
    ...
    {
        return view('Excel.mikrobiologi_bahan_kemas.export_mikrobiologi_bahan_kemas', [
            'mikrobiologi_bahan_kemas' => Mikrobiologi_bahan_kemas::where('id',$this->id)->first(),
            'sampel_mikrobiologi_bahan_kemas' => Sampel_mikrobiologi_bahan_kemas::where('id_bahan_kemas', $this->id)->get(),
        ]);
    }
