...
class MikrobiologiBahanBakuExport implements FromView, ShouldAutoSize, WithStyles, WithDrawings, WithEvents
{
    /**
    ...
    */
    ...
    {
        return view('Excel.mikrobiologi_bahan_baku.export_mikrobiologi_bahan_baku', [
            'mikrobiologi_bahan_baku' => Mikrobiologi_bahan_baku::where('id',$this->id)->first(),
            'sampel_mikrobiologi_bahan_baku' => Sampel_mikrobiologi_bahan_baku::where('id_bahan_baku', $this->id)->get(),
        ]);
    }
