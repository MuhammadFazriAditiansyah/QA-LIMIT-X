...
class MikrobiologiRuanganExport implements FromView, ShouldAutoSize, WithStyles, WithDrawings, WithEvents
{
    /**
    ...
    */
    ...
    {
        return view('Excel.mikrobiologi_ruangan.export_mikrobiologi_ruangan', [
            'mikrobiologi_ruangan' => Mikrobiologi_ruangan::where('id',$this->id)->first(),
            'sampel_mikrobiologi_ruangan' => Sampel_mikrobiologi_ruangan::where('id_ruangan', $this->id)->get(),
        ]);
    }
