...
class MikrobiologiPersonilExport implements FromView, ShouldAutoSize, WithStyles, WithDrawings, WithEvents
{
    /**
    ...
    */
    ...
    {
        return view('Excel.mikrobiologi_personil.export_mikrobiologi_personil', [
            'mikrobiologi_personil' => Mikrobiologi_personil::where('id',$this->id)->first(),
            'sampel_mikrobiologi_personil' => Sampel_mikrobiologi_personil::where('id_personil', $this->id)->get(),
        ]);
    }
