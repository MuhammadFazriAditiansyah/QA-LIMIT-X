...
class MikrobiologiAirExport implements FromView, ShouldAutoSize, WithStyles, WithDrawings, WithEvents
{
    /**
    ...
    */
    ...
    {
        return view('Excel.mikrobiologi_air.export_mikrobiologi_air', [
            'mikrobiologi_airs' => Mikrobiologi_air::where('id',$this->id)->first(),
            'sampel_mikrobiologi_airs' => Sampel_mikrobiologi_air::where('id_mikrobiologi', $this->id)->get(),
        ]);
    }
