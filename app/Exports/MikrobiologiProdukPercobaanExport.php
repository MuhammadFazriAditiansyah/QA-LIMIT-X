...
class MikrobiologiProdukPercobaanExport implements FromView, ShouldAutoSize, WithStyles, WithDrawings, WithEvents
{
    /**
    ...
    */
    ...
    {
        return view('Excel.mikrobiologi_produk_percobaan.export_mikrobiologi_produk_percobaan', [
            'mikrobiologi_produk_percobaan' => Mikrobiologi_produk_percobaan::where('id',$this->id)->first(),
            'sampel_mikrobiologi_produk_percobaan' => Sampel_mikrobiologi_produk_percobaan::where('id_produk_percobaan', $this->id)->get(),
        ]);
    }
