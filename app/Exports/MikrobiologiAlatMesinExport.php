...
class MikrobiologiAlatMesinExport implements FromView, ShouldAutoSize, WithStyles, WithDrawings, WithEvents
{
    /**
    ...
    */
    ...
    {
        return view('Excel.mikrobiologi_alat_mesin.export_mikrobiologi_alat_mesin', [
            'mikrobiologi_alat_mesin' => Mikrobiologi_alat_mesin::where('id',$this->id)->first(),
            'sampel_mikrobiologi_alat_mesin' => Sampel_mikrobiologi_alat_mesin::where('id_alat_mesin', $this->id)->get(),
        ]);
    }
