...
class MikrobiologiProdukExport implements FromView, ShouldAutoSize, WithStyles, WithDrawings, WithEvents
{
    /**
    ...
    */
    ...
    {
        return view('Excel.mikrobiologi_produk.export_mikrobiologi_produk', [
            'mikrobiologi_produks' => Mikrobiologi_produk::where('id',$this->id)->first(),
            'sampel_mikrobiologi_produks' => Sampel_mikrobiologi_produk::where('id_produk', $this->id)->get(),
        ]);
    }
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->getStyle('D6:L11')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_LEFT);
