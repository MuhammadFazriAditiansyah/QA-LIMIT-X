...
class MikrobiologiKimiaSensoriExport implements FromView, ShouldAutoSize, WithStyles, WithDrawings, WithEvents
{
    /**
    ...
    */
    ...
    {
        return view('Excel.mikrobiologi_kimia_sensori.export_mikrobiologi_kimia_sensori', [
            'mikrobiologi_kimia_sensori' => Mikrobiologi_kimia_sensori::where('id',$this->id)->first(),
            'sampel_mikrobiologi_kimia_sensori' => Sampel_mikrobiologi_kimia_sensori::where('id_kimia_sensori', $this->id)->get(),
        ]);
    }
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $lastFourRowsRange = 'A' . ($lastRow - 3) . ':N' . $lastRow;
